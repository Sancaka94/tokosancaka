...
<head>
    ...
    <title>Login Admin - Keuangan HIMA HKI</title>
    
    <!-- Favicon disesuaikan dengan Logo IAI Ngawi -->
...
<body class="bg-gray-50 flex items-center justify-center min-h-screen p-4 antialiased">
    ...
    <div class="w-full max-w-md bg-white p-8 rounded-2xl border border-gray-200 shadow-sm">
        ...
        <div class="text-center mb-8 flex flex-col items-center">
            <!-- Menampilkan Logo IAI Ngawi -->
            <img src="https://iaingawi.ac.id/assets/logo-iai.png" alt="Logo IAI Ngawi" class="w-16 h-16 object-contain drop-shadow-sm mb-4">
            <h1 class="text-2xl font-bold text-gray-900 tracking-tight">Login Admin</h1>
            <!-- Teks disesuaikan untuk HIMA -->
            <p class="text-sm text-gray-500 mt-1">Sistem Kas HIMA Prodi HKI - IAI Ngawi</p>
        </div>
