...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Sancaka Express'); ?></title>
    ...
    <!-- Custom CSS -->
    <link rel="stylesheet" href="<?php echo e(asset('public/assets/css/home-style.css')); ?>">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto align-items-lg-center">
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(request()->is('/') ? 'active fw-bold' : ''); ?>" href="<?php echo e(url('/')); ?>">Beranda</a>
                        </li>
                        <li class="nav-item">
...
<li class="nav-item dropdown">
    <a class="nav-link dropdown-toggle <?php echo e(request()->is('privacy-policy') || request()->is('terms-and-conditions') ? 'active fw-bold' : ''); ?>" 
       href="#" 
       id="legalDropdown" 
       role="button" 
    ...
    <ul class="dropdown-menu" aria-labelledby="legalDropdown">
        <li>
            <a class="dropdown-item <?php echo e(request()->is('privacy-policy') ? 'active fw-bold' : ''); ?>" 
               href="<?php echo e(route('privacy.policy')); ?>">
               Privacy Policy
            </a>
        </li>
        <li>
            <a class="dropdown-item <?php echo e(request()->is('terms-and-conditions') ? 'active fw-bold' : ''); ?>" 
               href="<?php echo e(route('terms.conditions')); ?>">
               Terms & Conditions
            </a>
        </li>
    </ul>
                        ...
                        <li class="nav-item ms-lg-2">
                            <a class="btn btn-orange d-flex align-items-center" href="<?php echo e(url('')); ?>/etalase">
                                <i class="fas fa-shopping-cart me-2"></i> Etalase
                            </a>
                        </li>
                        
                        <li class="nav-item ms-lg-2">
                            <a class="btn btn-success d-flex align-items-center" href="<?php echo e(url('')); ?>/blog">
                                ...
                                <div class="row">
                                    <div class="col-lg-3 col-md-6 mb-3 mb-lg-0">
                                        ...
                                        <ul class="list-unstyled megamenu-list">
                                            <?php $__currentLoopData = $rekanan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $name => $icon): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if(in_array($name, $kurirPopuler)): ?>
                                                    <li><a href="#"><i class="fa-solid <?php echo e($icon); ?> me-2"></i><?php echo e($name); ?></a></li>
                                                <?php endif; ?>
                                    ...
                                    <div class="col-lg-3 col-md-6 mb-3 mb-lg-0">
                                        ...
                                        <ul class="list-unstyled megamenu-list">
                                            <?php $__currentLoopData = $rekanan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $name => $icon): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if(in_array($name, $kargoLogistik)): ?>
                                                    <li><a href="#"><i class="fa-solid <?php echo e($icon); ?> me-2"></i><?php echo e($name); ?></a></li>
                                                <?php endif; ?>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </ul>
                                    ...
                                    <div class="col-lg-3 col-md-6 mb-3 mb-md-0">
                                        ...
                                        <ul class="list-unstyled megamenu-list">
                                            <?php $__currentLoopData = $rekanan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $name => $icon): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if(in_array($name, $lainnya)): ?>
                                                    <li><a href="#"><i class="fa-solid <?php echo e($icon); ?> me-2"></i><?php echo e($name); ?></a></li>
                                                <?php endif; ?>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            <li><hr class="my-2"></li>
                                            <li><a href="#"><i class="fa-solid <?php echo e($rekanan['SANCAKA EXPRESS']); ?> me-2"></i><strong>SANCAKA EXPRESS</strong></a></li>
                                        </ul>
                                    </div>
                                    <div class="col-lg-3 col-md-6">
                                        <div class="megamenu-feature">
                                            ...
                                            <a href="<?php echo e(route('scan.spx.show')); ?>" class="btn btn-primary btn-sm">Mulai Sekarang</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="d-lg-flex align-items-center mt-3 mt-lg-0 ms-lg-3">
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="mainDropdown">
                                <li><a class="dropdown-item" href="<?php echo e(route('login')); ?>"><i class="fa-solid fa-right-to-bracket me-2"></i> Login</a></li>
                                <li><a class="dropdown-item" href="<?php echo e(route('register')); ?>"><i class="fa-solid fa-user-plus me-2"></i>Daftar Akun Baru</a></li>
                                <li><hr class="dropdown-divider"></li>
                                <li><a class="dropdown-item" href="<?php echo e(route('pesanan.public.create')); ?>"><i class="fas fa-shipping-fast me-2"></i>Order via <strong>Sancaka Express</strong></a></li>
                                <li><a class="dropdown-item" href="<?php echo e(route('scan.spx.show')); ?>"><i class="fas fa-barcode me-2"></i> Input Resi SPX Express</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="row align-items-center">
                <div class="col-md-7 col-lg-8">
                    <p class="text-center text-md-start text-white-50">
                        &copy; <?php echo e(date('Y')); ?> <strong>Sancaka Express</strong> & Toko Sancaka All Rights Reserved.
                    </p>
                </div>
    ...
    <?php if(!empty($__debug)): ?>
    <div class="bg-yellow-100 text-yellow-800 p-4 text-sm border-t border-yellow-300 mt-8">
        <strong>🔧 DEBUG INFO:</strong>
        <pre class="whitespace-pre-wrap text-xs"><?php echo e(print_r($__debug, true)); ?></pre>
    </div>
    <?php endif; ?>
...
<?php /**PATH /home/tokq3391/public_html/resources/views/layouts/app.blade.php ENDPATH**/ ?>