                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-md-6 mb-3 mb-md-0">
                                        ...
                                        <ul class="list-unstyled megamenu-list">
                                            ...
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            <li><hr class="my-2"></li>
                                            <li><a href="#"><i class="fa-solid <?php echo e($rekanan['SANCAKA EXPRESS']); ?> me-2"></i>SANCAKA EXPRESS</a></li>
                                        </ul>
                                    </div>
                    ...
                    <div class="d-lg-flex align-items-center mt-3 mt-lg-0 ms-lg-3">
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="mainDropdown">
                                ...
                                <li><a class="dropdown-item" href="<?php echo e(route('pesanan.public.create')); ?>"><i class="fas fa-shipping-fast me-2"></i> Order via Sancaka Express</a></li>
            ...
            <div class="row align-items-center">
                <div class="col-md-7 col-lg-8">
                    <p class="text-center text-md-start text-white-50">
                        &copy; <?php echo e(date('Y')); ?> Sancaka Express & Toko Sancaka All Rights Reserved.
                    </p>
                </div>
