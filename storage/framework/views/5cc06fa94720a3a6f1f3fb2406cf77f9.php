<?php $__env->startSection('title', 'Selamat Datang di Sancaka Express'); ?>
        ...
        <div class="row g-4 row-cols-1 row-cols-lg-3">
            ...
            <div class="col">
                ...
                <div class="action-card h-100">
                    ...
                    <form action="<?php echo e(route('tracking.search')); ?>" method="GET" class="mt-auto">
...
<section id="blog" class="section">
    ...
    <div class="container">
        ...
        <div class="mb-5">
            ...
            <form action="<?php echo e(url()->current()); ?>" method="GET" class="max-w-xl mx-auto">

                <div class="input-group input-group-lg">

                    <input type="search" name="search" class="form-control" placeholder="Cari artikel berdasarkan judul atau konten..." value="<?php echo e(request('search')); ?>" aria-label="Cari Artikel">
        ...
        <?php if(request()->has('search') && request()->input('search') != ''): ?>

            <h4 class="mb-4 fw-bold">Hasil pencarian untuk: "<?php echo e(request('search')); ?>"</h4>

        <?php endif; ?>



        <?php if($headline && !request()->filled('search')): ?>
        ...
        <div class="row g-4 mb-5">
            ...
            <div class="col-lg-8">
                ...
                <div class="card post-card shadow-sm h-100">
                    ...
                    <a href="<?php echo e(route('blog.posts.show', $headline->slug)); ?>" class="text-decoration-none text-dark">

                        <img src="<?php echo e(Storage::url($headline->featured_image)); ?>"
                        ...
                        <div class="card-body p-4">
                            ...
                            <small class="text-primary fw-bold"><?php echo e($headline->category->name ?? 'UMUM'); ?></small>

                            <h3 class="card-title fw-bold mt-2"><?php echo e($headline->title); ?></h3>

                            <p class="card-text text-muted"><?php echo e(Str::limit(strip_tags($headline->content), 1000)); ?></p>

                            <small class="text-muted"><?php echo e($headline->created_at->diffForHumans()); ?></small>
            ...
            <div class="col-lg-4">
                ...
                <div class="d-flex flex-column gap-3 h-100">
                    ...
                    <a href="<?php echo e(route('blog.posts.show', $article->slug)); ?>" class="text-decoration-none text-dark">

                        <div class="card post-card shadow-sm flex-row h-100">

                           <img src="<?php echo e(Storage::url($article->featured_image)); ?>" class="w-25" style="aspect-ratio: 1/1; object-fit: cover;" onerror="this.onerror=null;this.src='https://placehold.co/100x100/CCCCCC/FFFFFF?text=Image';" alt="<?php echo e($article->title); ?>">

                            <div class="card-body d-flex align-items-center p-3">

                                <h6 class="fw-bold small mb-0"><?php echo e($article->title); ?></h6>
        ...
        <div class="row g-5">
            ...
            <div class="col-lg-8">
                ...
                <h4 class="fw-bold mb-4"><?php echo e(request()->filled('search') ? 'Hasil Ditemukan' : 'Lainnya dari Blog Kami'); ?></h4>
                    ...
                    <div class="card post-card mb-4 shadow-sm">
                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-md-4">
                                ...
                                <a href="<?php echo e(route('blog.posts.show', $post->slug)); ?>">

                                    <img src="<?php echo e(Storage::url($post->featured_image)); ?>" class="img-fluid rounded-start h-100 post-card-img" onerror="this.onerror=null;this.src='https://placehold.co/400x250/CCCCCC/FFFFFF?text=Image';" alt="<?php echo e($post->title); ?>">
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="card-body">
                                    ...
                                    <h5 class="card-title fw-bold">
                                        ...
                                        <a href="<?php echo e(route('blog.posts.show', $post->slug)); ?>" class="text-decoration-none text-dark"><?php echo e($post->title); ?></a>

                                    </h5>

                                    <p class="card-text text-muted small"><?php echo e(Str::limit(strip_tags($post->content), 500)); ?></p>

                                    <div class="d-flex justify-content-between align-items-center mt-3">

                                        <small class="text-muted"><?php echo e($post->created_at->diffForHumans()); ?> by <?php echo e($post->author->nama_lengkap ?? 'Admin'); ?></small>

                                        <a href="<?php echo e(route('blog.posts.show', $post->slug)); ?>" class="btn btn-sm btn-outline-primary">Baca Selengkapnya</a>
                ...
                <div class="d-flex flex-column align-items-center mt-4">
                    ...
                    <div class="mb-2 text-muted">
                        ...
                        Menampilkan <?php echo e($latestPosts->firstItem()); ?> - <?php echo e($latestPosts->lastItem()); ?>


                        dari total <?php echo e($latestPosts->total()); ?> post
                    ...
                    <div>
                        ...
                        <?php echo e($latestPosts->appends(request()->query())->links('pagination::bootstrap-5')); ?>
            ...
            <div class="col-lg-4">
                ...
                <div class="card shadow-sm sticky-top" style="top: 2rem;">
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $popularPosts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>

                        <a href="<?php echo e(route('blog.posts.show', $post->slug)); ?>" class="list-group-item list-group-item-action d-flex align-items-center">

                            <span class="fw-bold me-3 fs-4 text-muted"><?php echo e($key + 1); ?></span>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const apiUrls = {
        ...
        provinces: "<?php echo e(route('api.wilayah.provinces')); ?>",

        kabupaten: "<?php echo e(route('api.wilayah.kabupaten', ':id')); ?>",

        kecamatan: "<?php echo e(route('api.wilayah.kecamatan', ':id')); ?>",

        desa: "<?php echo e(route('api.kodepos.by-district', ':id')); ?>",

        search: "<?php echo e(route('api.kodepos.public.search')); ?>"
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const handleSearch = async (event) => {
        ...
        try {
            ...
            const response = await fetch(`<?php echo e(route('api.ongkir.address.search')); ?>?search=${query}`);
    ...
    shippingForm.addEventListener('submit', async function(event) {
        ...
        try {
            ...
            const response = await fetch("<?php echo e(route('api.ongkir.cost.check')); ?>", {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/tokq3391/public_html/resources/views/home.blade.php ENDPATH**/ ?>