    ...
    <header class="bg-white shadow-sm sticky top-0 z-50" x-data="{ mobileMenuOpen: false }">
        <div class="container mx-auto px-4">
            <div class="flex justify-between items-center h-20">
                <!-- Logo -->
                <a href="<?php echo e(url('/etalase')); ?>" class="flex-shrink-0">
                ...
                <div class="hidden md:flex flex-grow max-w-2xl mx-6">
                    <form action="<?php echo e(route('etalase.index')); ?>" method="GET" class="w-full flex border border-gray-300 rounded-lg overflow-hidden focus-within:ring-2 focus-within:ring-red-400 transition-all">
                ...
                <div class="hidden md:flex items-center space-x-4 flex-shrink-0">
                    ...
                    <?php if(auth()->guard()->check()): ?>
                        ...
                        <?php if(Auth::user()->role === 'Admin'): ?>
                            ...
                            <a href="<?php echo e(route('admin.dashboard')); ?>" class="px-5 py-2 text-sm font-semibold text-gray-700 border border-gray-300 rounded-full hover:bg-gray-100 transition-colors">Dashboard</a>
                        ...
                        <?php else: ?>
                            ...
                            <a href="<?php echo e(route('customer.dashboard')); ?>" class="px-5 py-2 text-sm font-semibold text-gray-700 border border-gray-300 rounded-full hover:bg-gray-100 transition-colors">Dashboard</a>
                    ...
                    <?php else: ?>
                        ...
                        <a href="<?php echo e(route('login')); ?>" class="px-5 py-2 text-sm font-semibold text-red-500 border border-red-500 rounded-full hover:bg-red-50 transition-colors">LOGIN</a>
                        <a href="<?php echo e(route('register')); ?>" class="px-5 py-2 text-sm font-semibold text-white bg-red-500 rounded-full hover:bg-red-600 transition-colors">DAFTAR</a>
                    <?php endif; ?>
                </div>
        ...
        <div x-show="mobileMenuOpen" @click.away="mobileMenuOpen = false" class="md:hidden bg-white border-t border-gray-200" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100" x-transition:leave="transition ease-in duration-150" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0">
            <div class="p-4 space-y-4">
                ...
                <form action="<?php echo e(route('etalase.index')); ?>" method="GET" class="w-full flex border border-gray-300 rounded-lg overflow-hidden focus-within:ring-2 focus-within:ring-red-400">
                ...
                <?php if(auth()->guard()->check()): ?>
                    <?php if(Auth::user()->role === 'Admin'): ?>
                        <a href="<?php echo e(route('admin.dashboard')); ?>" class="block w-full text-center px-5 py-2 text-sm font-semibold text-gray-700 border-2 border-gray-300 rounded-full hover:bg-gray-100 transition-colors">Dashboard</a>
                    ...
                    <?php else: ?>
                        <a href="<?php echo e(route('customer.dashboard')); ?>" class="block w-full text-center px-5 py-2 text-sm font-semibold text-gray-700 border-2 border-gray-300 rounded-full hover:bg-gray-100 transition-colors">Dashboard</a>
                    ...
                    <?php endif; ?>
                <?php else: ?>
                    <a href="<?php echo e(route('login')); ?>" class="block w-full text-center px-5 py-2 text-sm font-semibold text-red-500 border-2 border-red-500 rounded-full hover:bg-red-50 transition-colors">LOGIN</a>
                    <a href="<?php echo e(route('register')); ?>" class="block w-full text-center px-5 py-2 text-sm font-semibold text-white bg-red-500 rounded-full hover:bg-red-600 transition-colors">DAFTAR</a>
                <?php endif; ?>
            </div>
        </div>
    </header>
