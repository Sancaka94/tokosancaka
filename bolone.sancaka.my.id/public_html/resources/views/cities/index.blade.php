        ...
        <div class="flex justify-between items-center mb-8 border-b border-gray-200 pb-4">
            ...
            <div class="flex items-center gap-3">
                ...
                <a href="{{ route('transactions.create') }}" 
                   class="px-4 py-2 bg-green-600 text-white text-sm font-medium rounded-md hover:bg-green-700 transition-colors inline-flex items-center shadow-sm">
            ...
            <div class="bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden">
                <table class="min-w-full divide-y divide-gray-200 text-sm">
                    <thead class="bg-gray-50">
                        <tr>
                            <!-- HEADER CHECKBOX ALL (DITAMBAHKAN) -->
                    ...
                    <tbody class="divide-y divide-gray-200 bg-white">
                        @forelse($cities as $index => $city)
                            <tr class="hover:bg-gray-50 transition-colors">
                                <!-- KOLOM CHECKBOX PER BARIS (DITAMBAHKAN) -->
                                <td class="px-6 py-4">
                                ...
                                <td class="px-6 py-4 text-right flex justify-end gap-3 items-center">
                                    ...
                                    <!-- Tombol Hapus Tunggal (Dialihkan ke action hapus standar Laravel karena form tidak bisa bersarang) -->
                        ...
                        @empty
                            <tr>
                                <!-- Diubah colspan menjadi 5 karena nambah 1 kolom checkbox -->
