        ...
        <div class="bg-white border border-gray-200 rounded-lg shadow-sm p-6 mb-8">
            <div class="flex justify-between items-center mb-5">
                <div>
                    ...
                    <p class="text-xs text-gray-500 mt-1">Otomatis input banyak data. Pastikan format kolom sesuai dengan contoh.</p>
                </div>
                
                <!-- Tombol Download Contoh Format -->
                <a href="{{ route('transactions.example') }}" class="inline-flex items-center gap-2 px-3 py-1.5 text-xs font-medium text-white bg-red-600 rounded-md hover:bg-red-700 transition-all shadow-sm">
