...
<div onclick="openSpxGlobalModal()"
    class="fixed right-0 top-[calc(70%+25px)] transform -translate-y-1/2 pointer-events-auto bg-orange-500/95 backdrop-blur-sm border border-r-0 border-white/20 text-white py-5 px-1.5 rounded-l-2xl shadow-xl cursor-pointer transition-all duration-300 hover:bg-orange-600 hover:pr-4 z-[110]">
    <div class="flex flex-col items-center gap-2">
