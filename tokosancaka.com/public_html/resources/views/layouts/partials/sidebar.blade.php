...
<div x-data="{
    ...
    <aside id="main-sidebar"
        ...
        <nav id="sidebar-nav"
            ...
            <div x-data="{ open: {{ request()->routeIs(['admin.registrations.*', 'admin.customers.*', 'admin.roles.*']) ? 'true' : 'false' }} }"
                ...
                <div x-show="open && (isExpanded || isHovered || isMobile)" x-cloak class="mt-1">
                    <ul class="pl-9 pr-2 py-1 space-y-1">
                        ...
                        {{-- MENU BARU: WHITELIST & DUMMY --}}
                        <li>
                            <a href="{{ route('admin.whitelist.index') }}" wire:navigate x-show="!searchQuery || $el.textContent.toLowerCase().includes(searchQuery.toLowerCase())" class="block px-3 py-1.5 text-xs rounded-md transition-colors {{ request()->routeIs('admin.whitelist.*') ? 'text-blue-600 font-bold bg-blue-50' : 'text-gray-500 hover:text-blue-600 hover:bg-gray-50' }}">
                                Whitelist & Dummy
                            </a>
                        </li>
            ...
            {{-- Generate 2D Barcode --}}
            <a href="{{ route('barcode.create') }}" wire:navigate
               x-show="!searchQuery || $el.textContent.toLowerCase().includes(searchQuery.toLowerCase())"
               class="group flex items-center px-3 py-2 text-sm font-medium rounded-lg transition-colors duration-200 {{ request()->routeIs('barcode.*') ? 'bg-blue-600 text-white shadow-md shadow-blue-200' : 'text-gray-600 hover:bg-blue-600 hover:text-white' }}">
                <i class="fa-solid fa-qrcode fa-fw w-5 h-5 mr-2 flex-shrink-0 {{ request()->routeIs('barcode.*') ? 'text-white' : 'text-gray-400 group-hover:text-white' }}"></i>
            ...
            <div x-data="{ open: {{ request()->is('admin/products*') || request()->is('admin/spx-scans*') || request()->routeIs('admin.reviews.*') || request()->routeIs('admin.stores.*') || request()->routeIs('admin.orders.*') || request()->routeIs('admin.escrow.*') ? 'true' : 'false' }} }"
                -show="!searchQuery || $el.textContent.toLowerCase().includes(searchQuery.toLowerCase())"
                 x-effect="if(searchQuery && $el.textContent.toLowerCase().includes(searchQuery.toLowerCase())) open = true">
            ...
            {{-- ================= MENU PPOB IAK ================= --}}
            <div x-data="{ open: {{ request()->routeIs('ppob.*') ? 'true' : 'false' }} }"
                 x-show="!searchQuery || $el.textContent.toLowerCase().includes(searchQuery.toLowerCase())"
                 x-effect="if(searchQuery && $el.textContent.toLowerCase().includes(searchQuery.toLowerCase())) open = true">

                <button @click="open = !open; if(!isExpanded && !isHovered && !isMobile) isExpanded = true"
                        class="w-full flex items-center justify-between px-3 py-2 text-sm font-medium text-left rounded-lg transition-colors duration-200 group {{ request()->routeIs('ppob.*') ? 'bg-blue-600 text-white shadow-md shadow-blue-200' : 'text-gray-600 hover:bg-blue-600 hover:text-white' }}">
                    <span class="flex items-center">
                            <i class="fa-solid fa-mobile-screen-button fa-fw w-5 h-5 mr-2 flex-shrink-0 {{ request()->routeIs('ppob.*') ? 'text-white' : 'text-gray-400 group-hover:text-white' }}"></i>
                            <span :class="(isExpanded || isHovered) ? 'block' : 'block lg:hidden'" class="whitespace-nowrap">PPOB IAK</span>
                    </span>
                    <div :class="(isExpanded || isHovered) ? 'block' : 'block lg:hidden'">
                        <i class="fa-solid fa-chevron-down w-3 h-3 transform transition-transform duration-200"
                           :class="open && (isExpanded || isHovered || isMobile) ? 'rotate-180 text-white' : '{{ request()->routeIs('ppob.*') ? 'text-white' : 'text-gray-400 group-hover:text-white' }}'"></i>
                    </div>
                </button>
                <div x-show="open && (isExpanded || isHovered || isMobile)" x-cloak class="mt-1">
                    <ul class="pl-9 pr-2 py-1 space-y-1">
                        <li>
                            <a href="{{ route('ppob.index') }}" wire:navigate
                               x-show="!searchQuery || $el.textContent.toLowerCase().includes(searchQuery.toLowerCase())"
                               class="block px-3 py-1.5 text-xs rounded-md transition-colors {{ request()->routeIs('ppob.index') ? 'text-blue-600 font-bold bg-blue-50' : 'text-gray-500 hover:text-blue-600 hover:bg-gray-50' }}">
                                Transaksi Baru
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('ppob.iak.history') }}" wire:navigate
                               x-show="!searchQuery || $el.textContent.toLowerCase().includes(searchQuery.toLowerCase())"
                               class="block px-3 py-1.5 text-xs rounded-md transition-colors {{ request()->routeIs('ppob.iak.history') ? 'text-blue-600 font-bold bg-blue-50' : 'text-gray-500 hover:text-blue-600 hover:bg-gray-50' }}">
                                Riwayat Transaksi
                            </a>
                        </li>
            ...
            {{-- 3. Menu Dompet Utama DOKU --}}
            <a href="{{ route('admin.doku.balance') }}" wire:navigate
               x-show="!searchQuery || $el.textContent.toLowerCase().includes(searchQuery.toLowerCase())"
               class="group flex items-center px-3 py-2 text-sm font-medium rounded-lg transition-colors duration-200 {{ request()->routeIs('admin.doku.*') ? 'bg-blue-600 text-white shadow-md shadow-blue-200' : 'text-gray-600 hover:bg-blue-600 hover:text-white' }}">
                <i class="fa-solid fa-building-columns fa-fw w-5 h-5 mr-2 flex-shrink-0 {{ request()->routeIs('admin.doku.*') ? 'text-white' : 'text-gray-400 group-hover:text-white' }}"></i>
                <span :class="(isExpanded || isHovered) ? 'block' : 'block lg:hidden'" class="whitespace-nowrap">Dompet DOKU</span>
            </a>

            {{-- 4. Menu Top Up DANA Corporate --}}
            <a href="{{ route('admin.dana.topup_corporate_form') }}" wire:navigate
               x-show="!searchQuery || $el.textContent.toLowerCase().includes(searchQuery.toLowerCase())"
               class="group flex items-center px-3 py-2 text-sm font-medium rounded-lg transition-colors duration-200 {{ request()->routeIs('admin.dana.topup_corporate_form') ? 'bg-blue-600 text-white shadow-md shadow-blue-200' : 'text-gray-600 hover:bg-blue-600 hover:text-white' }}">
                <i class="fa-solid fa-money-check-dollar fa-fw w-5 h-5 mr-2 flex-shrink-0 {{ request()->routeIs('admin.dana.topup_corporate_form') ? 'text-white' : 'text-gray-400 group-hover:text-white' }}"></i>
                <span :class="(isExpanded || isHovered) ? 'block' : 'block lg:hidden'" class="whitespace-nowrap">Pencairan DANA</span>
            </a>

            {{-- 5. Menu Transfer Bank (Tarik Saldo) --}}
            <a href="{{ route('admin.dana.transfer_bank') }}" wire:navigate
               x-show="!searchQuery || $el.textContent.toLowerCase().includes(searchQuery.toLowerCase())"
               class="group flex items-center px-3 py-2 text-sm font-medium rounded-lg transition-colors duration-200 {{ request()->routeIs('admin.dana.transfer_bank') ? 'bg-blue-600 text-white shadow-md shadow-blue-200' : 'text-gray-600 hover:bg-blue-600 hover:text-white' }}">
            ...
            <div x-data="{ open: {{ request()->routeIs('invoice.*') ? 'true' : 'false' }} }"
                ...
                <button @click="open = !open; if(!isExpanded && !isHovered && !isMobile) isExpanded = true"
                        class="w-full flex items-center justify-between px-3 py-2 text-sm font-medium text-left rounded-lg transition-colors duration-200 group {{ request()->routeIs('invoice.*') ? 'bg-blue-600 text-white shadow-md shadow-blue-200' : 'text-gray-600 hover:bg-blue-600 hover:text-white' }}">
                    <span class="flex items-center">
                        ...
                        <span :class="(isExpanded || isHovered) ? 'block' : 'block lg:hidden'" class="whitespace-nowrap">Manajemen Invoice</span>
                    </span>
                    <div :class="(isExpanded || isHovered) ? 'block' : 'block lg:hidden'">
                        <i class="fa-solid fa-chevron-down w-3 h-3 transform transition-transform duration-200"
                           :class="open && (isExpanded || isHovered || isMobile) ? 'rotate-180 text-white' : '{{ request()->routeIs('invoice.*') ? 'text-white' : 'text-gray-400 group-hover:text-white' }}'"></i>
                    </div>
                </button>
                    ...
                    <ul class="pl-9 pr-2 py-1 space-y-1">
                        <li>
                            <a href="{{ route('invoice.create') }}" wire:navigate
                               x-show="!searchQuery || $el.textContent.toLowerCase().includes(searchQuery.toLowerCase())"
                               class="block px-3 py-1.5 text-xs rounded-md transition-colors {{ request()->routeIs('invoice.create') ? 'text-blue-600 font-bold bg-blue-50' : 'text-gray-500 hover:text-blue-600 hover:bg-gray-50' }}">
                                Buat Invoice Baru
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('invoice.index') }}" wire:navigate
                               x-show="!searchQuery || $el.textContent.toLowerCase().includes(searchQuery.toLowerCase())"
                               class="block px-3 py-1.5 text-xs rounded-md transition-colors {{ request()->routeIs('invoice.index') ? 'text-blue-600 font-bold bg-blue-50' : 'text-gray-500 hover:text-blue-600 hover:bg-gray-50' }}">
            ...
            {{-- Mesin Pencari Telegram Sancaka --}}
            <div x-data="{ open: {{ request()->routeIs('search.*') ? 'true' : 'false' }} }"
                 x-show="!searchQuery || $el.textContent.toLowerCase().includes(searchQuery.toLowerCase())"
                 x-effect="if(searchQuery && $el.textContent.toLowerCase().includes(searchQuery.toLowerCase())) open = true">

                <button @click="open = !open; if(!isExpanded && !isHovered && !isMobile) isExpanded = true"
                        class="w-full flex items-center justify-between px-3 py-2 text-sm font-medium text-left rounded-lg transition-colors duration-200 group {{ request()->routeIs('search.*') ? 'bg-blue-600 text-white shadow-md shadow-blue-200' : 'text-gray-600 hover:bg-blue-600 hover:text-white' }}">
                    <span class="flex items-center">
                            {{-- Menggunakan Icon Telegram / Magnifying Glass --}}
                            <i class="fa-solid fa-magnifying-glass-chart fa-fw w-5 h-5 mr-2 flex-shrink-0 {{ request()->routeIs('search.*') ? 'text-white' : 'text-gray-400 group-hover:text-white' }}"></i>
                            <span :class="(isExpanded || isHovered) ? 'block' : 'block lg:hidden'" class="whitespace-nowrap">Telegram Search</span>
                    </span>
                    <div :class="(isExpanded || isHovered) ? 'block' : 'block lg:hidden'">
                        <i class="fa-solid fa-chevron-down w-3 h-3 transform transition-transform duration-200"
                           :class="open && (isExpanded || isHovered || isMobile) ? 'rotate-180 text-white' : '{{ request()->routeIs('search.*') ? 'text-white' : 'text-gray-400 group-hover:text-white' }}'"></i>
                    </div>
                </button>
                <div x-show="open && (isExpanded || isHovered || isMobile)" x-cloak class="mt-1">
                    <ul class="pl-9 pr-2 py-1 space-y-1">
                        <li>
                            <a href="{{ route('search.admin') }}"
                               x-show="!searchQuery || $el.textContent.toLowerCase().includes(searchQuery.toLowerCase())"
                               class="block px-3 py-1.5 text-xs rounded-md transition-colors {{ request()->routeIs('search.admin') ? 'text-blue-600 font-bold bg-blue-50' : 'text-gray-500 hover:text-blue-600 hover:bg-gray-50' }}">
                                Panel Admin (Sumber)
                            </a>
                        </li>
                        <li>
                            {{-- Target _blank agar halaman public Bootstrap 5 terbuka di tab baru --}}
                            <a href="{{ route('search.index') }}" target="_blank"
                               x-show="!searchQuery || $el.textContent.toLowerCase().includes(searchQuery.toLowerCase())"
                               class="flex justify-between items-center px-3 py-1.5 text-xs rounded-md transition-colors text-gray-500 hover:text-blue-600 hover:bg-gray-50">
