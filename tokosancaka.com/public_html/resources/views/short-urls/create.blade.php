    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 sm:p-8">
        <form action="/shorten" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <input type="url" name="original_url" id="original_url" class="w-full px-4 py-2 rounded-lg border focus:border-blue-500 focus:ring-1 outline-none transition-colors @error('original_url') border-red-500 @else border-gray-300 @enderror" placeholder="https://..." value="{{ old('original_url') }}" required>
                @error('original_url')
