...
<body class="bg-gray-200 py-8 text-black">
    ...
    <div class="max-w-4xl mx-auto mb-6 flex flex-col sm:flex-row justify-between items-center no-print px-4 md:px-0 gap-3">
        <a href="javascript:history.back()" class="w-full sm:w-auto text-center bg-white border border-gray-200 text-black px-4 py-2 rounded-md hover:bg-gray-200 text-sm font-medium transition">
    ...
    <div class="max-w-4xl mx-auto bg-white p-8 md:p-12 print-container relative border border-gray-200">
        ...
        <div class="print-header flex flex-col md:flex-row justify-between items-start mb-10 pb-8 border-b border-gray-100 gap-8">
            ...
            <div class="w-full md:w-[320px] pt-2 md:pt-8 relative z-10 no-print">
                @if($isCancelled)
                    <div class="border border-gray-200 bg-gray-200 p-4 rounded-md text-right">
                ...
                @else
                    @if(session('error'))
                        <div class="border border-gray-300 bg-gray-200 text-black px-3 py-2 rounded-md mb-3 text-xs font-medium">
                            {{ session('error') }}
                        </div>
                    @endif
                    ...
                    @elseif(!$statusLunas && !empty($pesanan->payment_url))
                        <div class="border border-gray-200 bg-gray-200 p-4 rounded-md text-center">
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-10">
            ...
            <div class="w-full md:w-auto p-4 border border-gray-200 rounded-md text-center bg-gray-200/50 min-w-[200px]">
        ...
        <div class="mb-10 border border-gray-200 rounded-xl overflow-hidden">
                        ...
                        <td class="py-6 px-6 align-top">
                            <div class="flex items-start gap-4">
                                ...
                                <div class="w-full">
                                    ...
                                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-y-2 gap-x-6 text-[12px] bg-gray-200 p-4 rounded-lg border border-gray-100">
            ...
            <div class="bg-gray-200 border-t border-gray-200 p-6 flex justify-end">
        ...
        <div class="flex flex-col-reverse md:flex-row gap-8 mb-8">
            ...
            <div class="w-full md:w-3/4">
                ...
                <div class="border border-gray-200 rounded-lg overflow-hidden">
                    <table class="w-full text-[13px] text-left">
                        <thead class="bg-gray-200 border-b border-gray-200 text-gray-500">
                            <tr>
            ...
            <div class="w-full md:w-1/4">
                ...
                @if($isCancelled)
                    <div class="border border-gray-200 bg-gray-200 rounded-lg p-4 text-center">
                ...
                @elseif($statusLunas && $pesanan->resi)
                    <div class="border border-gray-200 bg-gray-200 rounded-lg p-4 text-center mb-3">
                        <p class="text-[10px] font-bold text-gray-400 uppercase tracking-wider mb-1">Status Paket</p>
                ...
                @else
                    <div class="h-[120px] bg-gray-200 border border-dashed border-gray-300 flex flex-col items-center justify-center rounded-lg">
    ...
    <div id="paymentModal" class="no-print fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center z-50 hidden transition-all duration-300">
        <div class="bg-white rounded-2xl shadow-2xl w-full max-w-3xl mx-4 sm:mx-auto flex flex-col max-h-[85vh]">
            ...
            <div class="p-5 overflow-y-auto custom-scrollbar flex-1 bg-gray-200/50">
                <ul id="paymentOptionsList" class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    @if($hasDanaBinding)
                        <li class="payment-option cursor-pointer flex items-center p-3 border border-gray-400 rounded-xl bg-gray-200 hover:border-black hover:shadow-md transition-all group"
                    ...
                    @else
                        <li class="col-span-1 flex items-center p-3 border border-dashed border-gray-300 rounded-xl bg-gray-200 justify-between">
