...
<head>
    ...
    <style>
        ...
        .watermark-bg {
            ...
            background-image: url("data:image/svg+xml,%3Csvg width='850' height='70' xmlns='http://www.w3.org/2000/svg'%3E%3Ctext x='425' y='45' fill='black' font-family='Arial, sans-serif' font-size='12' font-weight='400' text-anchor='middle'%3E{{ rawurlencode($wmText) }}%3C/text%3E%3C/svg%3E");
