                    ...
                    <tbody class="text-sm divide-y divide-gray-100">
                        ...
                        <tr class="hover:bg-gray-50/50 transition">
                           ...
                           <!-- KOLOM 1: WAKTU, ID & INFO AGEN -->
                            ...
                            <td class="p-4 align-top">
                                <p class="font-bold text-gray-800 text-xs uppercase mb-1">{{ $item->deskripsi_barang }}</p>
                                <div class="grid grid-cols-1 gap-1 text-[11px]">
                                    ...
                                    @php
                                        ...
                                        // Karena di DB tidak ada kolom khusus "fee_cod", kita cari selisihnya dari grand_total
                                        $biayaAdminDanAsuransi = 0;
                                        if ($isCodPaket) {
                                            if ($isCodOngkirSaja) {
                                                // Jika COD Ongkir: Grand Total = Ongkir + Fee + Asuransi
                                                $biayaAdminDanAsuransi = $item->grand_total - $item->ongkir;
                                            } else {
                                                // Jika COD Barang: Grand Total = Barang + Ongkir + Fee + Asuransi
                                    ...
                                    @if($item->asuransi && !$isCodPaket)
                                        <div class="mt-1 pt-1 border-t border-gray-100">
                                            ...
                                            <span class="font-bold text-green-600">Ya (Nilai Barang: Rp {{ number_format($item->nilai_barang, 0, ',', '.') }})</span>
                                        </div>
                                    ...
                                    @if($isCodPaket)
                                        <div class="mt-2 p-2 bg-red-50 border border-red-100 rounded-md shadow-sm">
                                            ...
                                            <div class="space-y-0.5">
                                                ...
                                                @else
                                                <div class="flex justify-between" title="Acuan Klaim Asuransi">
                                                    <span class="text-gray-500">Nilai Barang:</span>
                                                    <span class="font-medium">Rp {{ number_format($item->nilai_barang, 0, ',', '.') }}</span>
                                                </div>
                                                @endif
