        ...
        <div class="flex flex-col md:flex-row gap-8 items-start">
            ...
            <div class="w-full md:w-80 shrink-0 flex flex-col gap-4">
                ...
                <div class="bg-white rounded-lg border border-zinc-200 shadow-sm p-3 flex flex-col gap-1.5">
                    ...
                    {{-- Menu Autokirim --}}
                    <div class="flex items-center justify-between w-full px-3 py-2.5 rounded-md cursor-pointer transition-colors"
                         :class="activeTab === 'autokirim' ? 'bg-zinc-100/80 border border-zinc-200/50 shadow-sm' : 'hover:bg-zinc-50 border border-transparent'"
                         @click="activeTab = 'autokirim'">
                        <span class="text-sm font-semibold" :class="activeTab === 'autokirim' ? 'text-zinc-900' : 'text-zinc-600'">Autokirim</span>
                        <div class="flex items-center space-x-1.5" @click.stop>
                            <span class="text-[9px] font-bold uppercase tracking-wider" :class="autokirimData.mode === 'production' ? 'text-zinc-400' : 'text-zinc-600'">SBX</span>
                            <button type="button" class="relative inline-flex h-4 w-8 shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none"
                                    :class="autokirimData.mode === 'production' ? 'bg-zinc-900' : 'bg-zinc-300'"
                                    @click="autokirimData.mode = (autokirimData.mode === 'production' ? 'sandbox' : 'production')">
                                <span class="inline-block h-3 w-3 transform rounded-full bg-white shadow transition duration-200 ease-in-out"
                                      :class="autokirimData.mode === 'production' ? 'translate-x-4' : 'translate-x-0'"></span>
                            </button>
                            <span class="text-[9px] font-bold uppercase tracking-wider" :class="autokirimData.mode === 'production' ? 'text-zinc-900' : 'text-zinc-400'">PROD</span>
                        </div>
                    </div>
                    ...
                    {{-- Menu BCA --}}
                    <div class="flex items-center justify-between w-full px-3 py-2.5 rounded-md cursor-pointer transition-colors"
                         :class="activeTab === 'bca' ? 'bg-zinc-100/80 border border-zinc-200/50 shadow-sm' : 'hover:bg-zinc-50 border border-transparent'"
                         @click="activeTab = 'bca'">
                        <span class="text-sm font-semibold" :class="activeTab === 'bca' ? 'text-zinc-900' : 'text-zinc-600'">BCA API</span>
                        <div class="flex items-center space-x-1.5" @click.stop>
                            <span class="text-[9px] font-bold uppercase tracking-wider" :class="bcaData.mode === 'production' ? 'text-zinc-400' : 'text-zinc-600'">SBX</span>
                            <button type="button" class="relative inline-flex h-4 w-8 shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none"
                                    :class="bcaData.mode === 'production' ? 'bg-zinc-900' : 'bg-zinc-300'"
                                    @click="bcaData.mode = (bcaData.mode === 'production' ? 'sandbox' : 'production')">
                                <span class="inline-block h-3 w-3 transform rounded-full bg-white shadow transition duration-200 ease-in-out"
                                      :class="bcaData.mode === 'production' ? 'translate-x-4' : 'translate-x-0'"></span>
                            </button>
                            <span class="text-[9px] font-bold uppercase tracking-wider" :class="bcaData.mode === 'production' ? 'text-zinc-900' : 'text-zinc-400'">PROD</span>
                        </div>
                    </div>
            ...
            <div class="flex-1 w-full bg-white rounded-lg border border-zinc-200 shadow-sm min-h-[400px]">
               ...
               {{-- 14. TAB MAPBOX --}}
                        ...
                        {{-- 🔥 PENGATURAN KOMISI & PAJAK 🔥 --}}
                                    <div class="px-6 pt-6 pb-6 mt-4 border-t border-zinc-200">
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                            ...
                                            {{-- KOMISI ADMIN --}}
                                            <div class="bg-zinc-50 border border-zinc-200 p-5 rounded-lg flex flex-col h-full shadow-sm">
                                                <h6 class="font-bold text-xs text-zinc-800 uppercase border-b border-zinc-200 pb-3 mb-4">Komisi Admin (ID 4)</h6>
                                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 flex-1">
                                                    <div>
                                                        <label class="block text-[10px] font-medium text-zinc-700 uppercase mb-1">Tipe Potongan</label>
                                                        <select name="komisi_admin_type" x-model="mapboxData.komisi.admin_type" class="block w-full rounded-md border-zinc-300 focus:border-zinc-900 focus:ring-zinc-900 sm:text-xs p-2.5 border bg-white">
                                                    ...
                                                    <div>
                                                        ...
                                                        <input type="number" name="komisi_admin_amount" x-model="mapboxData.komisi.admin_amount" class="block w-full rounded-md border-zinc-300 focus:border-zinc-900 sm:text-xs p-2.5 border" required min="0">
                                                        <p class="text-[10px] text-zinc-500 mt-1.5">Isi 0 jika bebas potongan.</p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="bg-zinc-50 border border-zinc-200 p-5 rounded-lg flex flex-col h-full shadow-sm">
                                                <h6 class="font-bold text-xs text-zinc-800 uppercase border-b border-zinc-200 pb-3 mb-4">Komisi Driver Reguler</h6>
                                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 flex-1">
                                                    <div>
                                                        <label class="block text-[10px] font-medium text-zinc-700 uppercase mb-1">Tipe Potongan</label>
                                                        <select name="komisi_driver_type" x-model="mapboxData.komisi.driver_type" class="block w-full rounded-md border-zinc-300 focus:border-zinc-900 focus:ring-zinc-900 sm:text-xs p-2.5 border bg-white">
                                                            <option value="percent">Persentase (%)</option>
                                                            <option value="nominal">Nominal (Rp)</option>
                                                        </select>
                                                    </div>
                                                    <div>
                                                        <label class="block text-[10px] font-medium text-zinc-700 uppercase mb-1">Besaran / Nilai</label>
                                                        <input type="number" name="komisi_driver_amount" x-model="mapboxData.komisi.driver_amount" class="block w-full rounded-md border-zinc-300 focus:border-zinc-900 sm:text-xs p-2.5 border" required min="0">
                                                        <p class="text-[10px] text-zinc-500 mt-1.5">Misal: 10 (%) atau 2000 (Rp).</p>
                                                    </div>
                                                </div>
                                            </div>

                                            {{-- PAJAK & BIAYA TAMBAHAN (GLOBAL) --}}
                                            <div class="bg-zinc-50 border border-zinc-200 p-5 rounded-lg md:col-span-2 shadow-sm">
                                                <h6 class="font-bold text-xs text-zinc-800 uppercase border-b border-zinc-200 pb-3 mb-4">Pajak & Biaya Tambahan (Global)</h6>
                                                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                                    <div>
                                                        <label class="block text-[10px] font-medium text-zinc-700 uppercase mb-1">Pajak Aplikasi (%)</label>
                                                        <input type="number" step="0.1" name="komisi_pajak_percent" x-model="mapboxData.komisi.pajak_percent" class="block w-full rounded-md border-zinc-300 focus:border-zinc-900 sm:text-xs p-2.5 border" required min="0">
                                                        <p class="text-[10px] text-zinc-500 mt-1.5">Dipotong dari total tarif.</p>
                                                    </div>
                                                    <div>
                                                        <label class="block text-[10px] font-medium text-zinc-700 uppercase mb-1">Biaya Tambahan (Rp)</label>
                                                        <input type="number" name="komisi_biaya_nominal" x-model="mapboxData.komisi.biaya_nominal" class="block w-full rounded-md border-zinc-300 focus:border-zinc-900 sm:text-xs p-2.5 border" required min="0">
                                                        <p class="text-[10px] text-zinc-500 mt-1.5">Potongan flat/nominal tetap.</p>
                                                    </div>
                                                    <div>
                                                        <label class="block text-[10px] font-medium text-zinc-700 uppercase mb-1">Keterangan Biaya Tambahan</label>
                                                        <input type="text" name="komisi_biaya_ket" x-model="mapboxData.komisi.biaya_ket" class="block w-full rounded-md border-zinc-300 focus:border-zinc-900 sm:text-xs p-2.5 border font-medium text-blue-700" required>
                                                        <p class="text-[10px] text-zinc-500 mt-1.5">Teks ini akan muncul di aplikasi driver.</p>
                                                    </div>
                                                </div>
                                            </div>
                ...
                {{-- TAB AUTOKIRIM --}}
                <div x-show="activeTab === 'autokirim'" style="display:none;" x-transition.opacity>
                    <div class="p-6 border-b border-zinc-200">
                        <div class="flex items-center gap-4 mb-1">
                            <h3 class="text-lg font-bold text-zinc-900">Autokirim H2H</h3>
                            <div class="flex items-center space-x-2 bg-zinc-100 px-2.5 py-1 rounded-full border border-zinc-200">
                                <span class="text-[10px] font-bold text-zinc-500 uppercase tracking-wider">Sandbox</span>
                                <div class="relative inline-block w-8 align-middle select-none transition duration-200">
                                    <input type="checkbox" class="toggle-checkbox absolute block w-4 h-4 rounded-full bg-white border-2 appearance-none cursor-pointer transition-all transform translate-x-0" :class="{'translate-x-full border-zinc-900': autokirimData.mode === 'production', 'border-zinc-300': autokirimData.mode === 'sandbox'}" @click="autokirimData.mode = (autokirimData.mode === 'production' ? 'sandbox' : 'production')" :checked="autokirimData.mode === 'production'"/>
                                    <label class="toggle-label block overflow-hidden h-4 rounded-full bg-zinc-200 cursor-pointer transition-colors duration-300"></label>
                                </div>
                                <span class="text-[10px] font-bold text-zinc-900 uppercase tracking-wider">Production</span>
                            </div>
                        </div>
                        <p class="text-sm text-zinc-500">Konfigurasi API Autokirim (Token H2H & Base URL).</p>
                    </div>
                    <form action="{{ route('admin.settings.api.update') }}" method="POST" class="p-6 space-y-5">
                        @csrf @method('PUT')
                        <input type="hidden" name="type" value="autokirim">
                        <input type="hidden" name="autokirim_mode" x-model="autokirimData.mode">

                        <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                            <div class="sm:col-span-2">
                                <label class="block text-xs font-medium text-zinc-700 uppercase">Bearer Token H2H</label>
                                <input type="text" name="autokirim_token" x-model="autokirimData[autokirimData.mode].token" class="mt-1 block w-full rounded-md border-zinc-300 focus:border-zinc-900 focus:ring-zinc-900 sm:text-sm p-2 border font-mono">
                            </div>
                            <div class="sm:col-span-2">
                                <label class="block text-xs font-medium text-zinc-700 uppercase">Base URL</label>
                                <input type="url" name="autokirim_base_url" x-model="autokirimData[autokirimData.mode].base_url" class="mt-1 block w-full rounded-md border-zinc-300 focus:border-zinc-900 focus:ring-zinc-900 sm:text-sm p-2 border font-mono" placeholder="Biarkan kosong untuk URL bawaan">
                            </div>

                            {{-- Webhook Info Box --}}
                            <div class="sm:col-span-2 p-3 bg-zinc-50 border border-zinc-200 rounded">
                                <p class="text-[10px] text-zinc-500 font-bold mb-1 uppercase tracking-wider">Webhook URL Endpoint Anda</p>
                                <p class="text-xs font-mono text-zinc-900 break-all select-all flex items-center">
                                    <i class="fas fa-plug text-zinc-400 mr-2"></i>
                                    https://{{ Request::getHost() }}/api/autokirim/webhook
                                </p>
                                <p class="text-[10px] text-zinc-500 mt-1">*Informasikan URL Webhook di atas ke tim developer Autokirim agar sistem Anda bisa menerima update status pesanan otomatis.</p>
                            </div>
                        </div>
                ...
                {{-- TAB BCA --}}
                <div x-show="activeTab === 'bca'" style="display:none;" x-transition.opacity>
                    <div class="p-6 border-b border-zinc-200">
                        <div class="flex items-center gap-4 mb-1">
                            <h3 class="text-lg font-bold text-zinc-900">BCA Corporate API</h3>
                            <div class="flex items-center space-x-2 bg-zinc-100 px-2.5 py-1 rounded-full border border-zinc-200">
                                <span class="text-[10px] font-bold text-zinc-500 uppercase tracking-wider">Sandbox</span>
                                <div class="relative inline-block w-8 align-middle select-none transition duration-200">
                                    <input type="checkbox" class="toggle-checkbox absolute block w-4 h-4 rounded-full bg-white border-2 appearance-none cursor-pointer transition-all transform translate-x-0" :class="{'translate-x-full border-zinc-900': bcaData.mode === 'production', 'border-zinc-300': bcaData.mode === 'sandbox'}" @click="bcaData.mode = (bcaData.mode === 'production' ? 'sandbox' : 'production')" :checked="bcaData.mode === 'production'"/>
                                    <label class="toggle-label block overflow-hidden h-4 rounded-full bg-zinc-200 cursor-pointer transition-colors duration-300"></label>
                                </div>
                                <span class="text-[10px] font-bold text-zinc-900 uppercase tracking-wider">Production</span>
                            </div>
                    ...
                    <form action="{{ route('admin.settings.api.update') }}" method="POST" class="p-6 space-y-5">
                        ...
                        <input type="hidden" name="bca_mode" :value="bcaData.mode || 'sandbox'">

                        <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                            <div>
                                <label class="block text-xs font-medium text-zinc-700 uppercase">Client ID</label>
                                <input type="text" name="bca_client_id" x-model="bcaData[bcaData.mode].client_id" class="mt-1 block w-full rounded-md border-zinc-300 focus:border-zinc-900 focus:ring-zinc-900 sm:text-sm p-2 border font-mono">
                            </div>
                            <div>
                                <label class="block text-xs font-medium text-zinc-700 uppercase">Client Secret</label>
                                <input type="text" name="bca_client_secret" x-model="bcaData[bcaData.mode].client_secret" class="mt-1 block w-full rounded-md border-zinc-300 focus:border-zinc-900 focus:ring-zinc-900 sm:text-sm p-2 border font-mono">
                            </div>
                            <div>
                                <label class="block text-xs font-medium text-zinc-700 uppercase">API Key</label>
                                <input type="text" name="bca_api_key" x-model="bcaData[bcaData.mode].api_key" class="mt-1 block w-full rounded-md border-zinc-300 focus:border-zinc-900 focus:ring-zinc-900 sm:text-sm p-2 border font-mono">
                            </div>
                            <div>
                                <label class="block text-xs font-medium text-zinc-700 uppercase">API Secret</label>
                                <input type="text" name="bca_api_secret" x-model="bcaData[bcaData.mode].api_secret" class="mt-1 block w-full rounded-md border-zinc-300 focus:border-zinc-900 focus:ring-zinc-900 sm:text-sm p-2 border font-mono">
                            </div>
                            <div class="sm:col-span-2">
                                <label class="block text-xs font-medium text-zinc-700 uppercase">Private Key (Format .pem)</label>
