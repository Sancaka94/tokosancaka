...
<div class="max-w-6xl mx-auto px-4 py-8 font-sans" x-data="orderForm">
    <div class="mb-8 border-b border-gray-200 pb-5 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div>
            <h1 class="text-3xl font-extrabold text-black tracking-tight">Kirim Paket Massal <span class="text-grey-500 font-medium">Sancaka Express </span><span class="text-red-500 font-medium"> (Multi Koli)</span></h1>
