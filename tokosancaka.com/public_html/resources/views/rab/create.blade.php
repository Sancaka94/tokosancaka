...
<div class="max-w-3xl mx-auto py-8">
    <div class="mb-6">
        <!-- PERBAIKAN 1: Ubah route kembali ke proyek.show -->
        <a href="{{ route('proyek.show', $proyek->id) }}" class="text-sm text-gray-500 hover:text-gray-900 mb-2 inline-block">&larr; Kembali</a>
    ...
    <div class="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
        <form action="{{ route('rab.store') }}" method="POST" class="space-y-6">
            ...
            <!-- PERBAIKAN 2: Tambahkan hidden input proyek_id -->
