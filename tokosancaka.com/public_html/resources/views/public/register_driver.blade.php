...
<div class="container py-5">
    <div class="row justify-content-center">
        {{-- Diperlebar menjadi col-xl-10 agar form landscape tidak terlalu sempit --}}
        <div class="col-xl-10 col-lg-12">
            <div class="card border-0 shadow-sm rounded-4">
                <div class="card-body p-4 p-md-5">
                    <h3 class="fw-bold mb-4 text-center">Gabung Menjadi Mitra Driver Sancaka</h3>
                    ...
                    <form action="{{ route('driver.register.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        {{-- Membagi form menjadi 2 kolom utama untuk Desktop (Landscape) --}}
                        <div class="row">
                            ...
                            {{-- ================= KOLOM KANAN ================= --}}
                            <div class="col-lg-6 mb-4">
                                <h5 class="fw-bold mb-3 border-bottom pb-2">Upload Dokumen (JPG/PNG/PDF)</h5>
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 col-lg-12 col-xl-6 mb-3">
                                        <label class="form-label text-muted fw-semibold">Foto Motor Samping (Wajib)</label>
                        ...
                        {{-- Tombol submit diposisikan di bawah kedua kolom --}}
                        <div class="row">
                            <div class="col-12">
