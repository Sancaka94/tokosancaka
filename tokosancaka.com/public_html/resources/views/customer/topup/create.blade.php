...
@section('content')
    <div class="mb-6">
        <h3 class="text-3xl font-bold text-gray-800 tracking-tight">Top Up Saldo</h3>
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                                ...
                                <label class="relative cursor-pointer group">
                                    ...
                                    <div class="h-full p-4 bg-white border-2 border-gray-200 rounded-xl hover:border-blue-400 peer-checked:border-blue-600 peer-checked:bg-blue-50 peer-checked:shadow-md transition-all flex flex-col items-center text-center">
                                        ...
                                        <span class="text-sm font-bold text-gray-800">DANA Direct</span>
                                        <span class="text-[10px] text-blue-500 font-semibold bg-blue-100 px-2 py-0.5 rounded mt-1">Checkout Instan</span>
                                        ...
                                        @foreach($channels as $channel)
                                            ...
                                            <label class="relative cursor-pointer group">
                                                ...
                                                <div class="h-full p-4 bg-white border-2 border-gray-200 rounded-xl hover:border-blue-400 peer-checked:border-blue-600 peer-checked:bg-blue-50 transition-all flex flex-col items-center text-center shadow-sm hover:shadow-md">
                                                    ...
                                                    <span class="mt-auto text-[10px] text-gray-500 font-medium bg-gray-50 border border-gray-100 px-2 py-1 rounded w-full">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.btn-quick-amount').on('click', function() {
                ...
                // Styling Reset: Kembalikan semua tombol ke default
                ...
                // Styling Active: Highlight tombol yang diklik
                ...
                // Isi nilai ke input & trigger change agar Consult Pay jalan
                $input.val(val).trigger('change');
            });

            // Sinkronisasi input manual: jika user ngetik manual, hilangkan highlight tombol
