{{--
    File: resources/views/customer/profile/setup.blade.php (Sesuai dengan route 'update.setup')
    Deskripsi: Halaman untuk melengkapi profil pelanggan setelah registrasi, dilengkapi autofill alamat KiriminAja.
--}}
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const SEARCH_ROUTE = '{{ route("customer.kiriminaja.address_search") }}'; // Route yang harus Anda buat!
