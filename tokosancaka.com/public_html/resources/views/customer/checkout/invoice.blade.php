        ...
        <div class="bg-white rounded-xl shadow-2xl w-full max-w-4xl overflow-hidden">
            ...
            <div class="flex flex-col md:flex-row">
                ...
                <div class="w-full md:w-1/2 p-8 bg-gray-50 md:border-l border-t md:border-t-0 border-gray-200">
                     ...
                     {{-- === KODE TRIPAY / DOKU DITAMBAHKAN DI SINI === --}}
                     ...
                     @if($status === 'pending')
                        <div class="h-full flex flex-col justify-center">
                            ...
                            <div class="text-center">
                                ...
                                @elseif (in_array($method, ['DANA', 'OVO', 'SHOPEEPAY']) || str_contains($method, 'DOKU_JOKUL'))
                                    {{-- E-Wallet / DOKU redirect --}}
                                    <script>
                     ...
                     {{-- Tampilkan ini jika pembayaran SUDAH LUNAS (bukan 'pending') --}}
                     @else
                        <div class="h-full flex flex-col justify-center items-center text-center">
                           <h2 class="text-lg font-semibold text-gray-800">Pesanan Diterima</h2>
                           <p class="text-gray-600 mt-2">Terima kasih atas pesanan Anda. Kami akan segera memprosesnya.</p>
                           <a href="/customer/pesanan/riwayat" class="mt-6 px-6 py-2 bg-red-600 text-white font-semibold rounded-lg shadow-md hover:bg-red-700">
                               Cek Data Riwayat Pesanan Marketplace
                           </a>
                        </div>
                     @endif
                     
                     {{-- === AKHIR DARI KODE TRIPAY / DOKU === --}}
                </div>
            </div>
        </div>
    </div>
