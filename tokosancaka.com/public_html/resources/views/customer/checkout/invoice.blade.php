...
@section('content')
    @php
        ...
        $isCancelled = in_array($statusRaw, ['batal', 'cancel', 'refund']);
    ...
    <style>
        ...
        /* Font utama diubah agar lebih modern */
        ...
        /* DESAIN PITA (Hanya ini yang berwarna) */
        .ribbon-wrapper {
    ...
    <div class="bg-gradient-to-br from-gray-100 to-gray-300 min-h-screen flex items-center justify-center p-4 sm:p-6 invoice-body-font text-black">
        <div class="bg-white rounded-xl shadow-2xl w-full max-w-5xl overflow-hidden relative border border-gray-200">
            ...
            <div class="p-8 md:p-10 border-b border-gray-100 relative z-10">
                <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                    ...
                    <div class="flex items-start">
                        <!-- Menggunakan Logo Sancaka yang Baru -->
                        <img src="https://tokosancaka.com/storage/uploads/sancaka.png" alt="CV. Sancaka Karya Hutama" class="h-16 w-auto object-contain mr-4" onerror="this.src='https://tokosancaka.biz.id/storage/uploads/logo.jpeg'">
                        <div>
                    ...
                    <div class="text-left md:text-right w-full md:w-auto">
                        <h1 class="text-3xl font-black text-black uppercase tracking-tight">INVOICE</h1>
                            ...
                            <tbody class="divide-y divide-gray-200">
                                ...
                                <tr>
                                    <td class="py-4 align-top pr-4">
                                        <div class="flex items-start">
                                            <!-- Gambar Item -->
                                            <div class="h-10 w-10 flex-shrink-0 border border-gray-200 mr-3 rounded overflow-hidden hidden sm:block">
                    ...
                    @if($statusRaw === 'pending')
                        ...
                        <div class="w-full bg-white p-6 rounded-xl border border-gray-200 shadow-sm flex-1 flex flex-col justify-center">
                            ...
                            @elseif (in_array($method, ['DANA', 'OVO']) || str_contains($method, 'DOKU_JOKUL'))
                                ...
                                <a href="{{ $url }}" target="_blank" class="block w-full py-3 bg-black text-white text-xs font-bold uppercase tracking-wider rounded hover:bg-gray-800 transition">
                            ...
                            @elseif(!empty($order->pay_code))
                                ...
                                <div class="bg-slate-100 py-4 border border-gray-300 rounded mb-4">
                                    <span class="text-xl font-mono font-black text-black tracking-widest">{{ $order->pay_code }}</span>
                                </div>
                                <p class="text-[10px] text-gray-400 italic">Gunakan kode di atas untuk menyelesaikan pembayaran.</p>
                            @else
                                <a href="{{ $url }}" target="_blank" class="block w-full py-3 bg-black text-white text-xs font-bold uppercase tracking-wider rounded hover:bg-gray-800 transition">
                    ...
                    @else
                        ...
                        <div class="w-full flex-1 flex flex-col justify-center items-center py-10">
                            @if($isLunas)
                                ...
                                <p class="text-xs text-gray-500 mt-2 max-w-[200px] leading-relaxed">Pesanan Anda telah dibayar dan sedang dalam proses.</p>
                            @elseif($isCancelled)
                                <div class="w-16 h-16 bg-white border border-gray-200 text-black rounded-full flex items-center justify-center text-3xl shadow-sm mb-4">
                                    <i class="fas fa-times"></i>
                                </div>
                                <h2 class="text-lg font-black text-black uppercase tracking-tight">Pesanan Dibatalkan</h2>
                                <p class="text-xs text-gray-500 mt-2 max-w-[200px] leading-relaxed">Transaksi tidak dilanjutkan atau telah dibatalkan.</p>
                            @endif

                            <!-- Tombol Download PDF -->
                            <a href="{{ url('invoice/' . $order->invoice_number . '/pdf') }}" target="_blank" class="no-print mt-8 px-6 py-2 bg-white border border-black text-black text-xs font-bold uppercase tracking-wider hover:bg-gray-100 transition shadow-sm flex items-center">
