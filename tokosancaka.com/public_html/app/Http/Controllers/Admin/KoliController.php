...
class KoliController extends Controller
{
    ...
    public function store(Request $request, KiriminAjaService $kirimaja)
    {
        ...
        try {
            ...
            if ($request->payment_method === 'Potong Saldo') {
                ...
                if ($user->saldo < $grandTotalTagihan) throw new Exception("Saldo Admin tidak cukup.");
            ...
            return redirect()->route('admin.pesanan.index')->with('success', count($createdOrders) . " Pesanan berhasil dibuat!");
    ...
    public function storeSingle(Request $request, KiriminAjaService $kirimaja)
    {
        ...
        try {
            ...
            if ($request->payment_method === 'Potong Saldo') {
                $user = User::find(Auth::id());
                if ($user->saldo < $pesanan->price) throw new Exception("Saldo Admin tidak cukup.");
