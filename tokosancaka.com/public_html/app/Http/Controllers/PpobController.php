...
class PpobController extends Controller
{
    ...
    public function __construct(DigiflazzService $digiflazz)
    {
        ...
        // 👇 1. Ambil mode yang sedang aktif (development / production)
        ...
        // 👇 3. Set true jika production, false jika development/sandbox
        $isProduction = ($mode === 'production');

        // 👇 4. Terapkan kredensial secara dinamis ke Digiflazz Service
