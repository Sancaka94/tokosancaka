...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::get('/driver/cek-koordinator', [\App\Http\Controllers\Api\Mobile\ApiMapboxController::class, 'cek_koordinator']);
    ...
    Route::post('/driver/accept-order', [ApiMapboxController::class, 'accept_order']);
    ...
    Route::post('/call/reject', [ApiMapboxController::class, 'reject_call_helpdesk']);
    // ==========================================
...
Route::get('/check-update', function(Request $request) {
    ...
    $latestVersion = '1.1.15'; // Ubah ini setiap kali ada rilis versi baru di Play Store
