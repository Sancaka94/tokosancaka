<x-guest-layout>
    <div class="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-gray-900">
        ...
        <img src="https://ponpes.tokosancaka.com/storage/auth/bg_ponpes.jpg" 
             class="absolute inset-0 w-full h-full object-cover opacity-60 transition-transform duration-1000" 
             alt="Background Full">
        
        <div class="absolute inset-0 bg-gradient-to-br from-indigo-900/40 via-transparent to-black/40"></div>

        <div class="relative z-10 grid lg:grid-cols-2 w-full min-h-screen">
            
            <div class="hidden lg:flex flex-col items-center justify-center p-16">
                <div class="w-full max-w-lg">
                    <div class="inline-flex items-center gap-2 bg-white/10 backdrop-blur-md border border-white/30 px-4 py-2 rounded-xl mb-8 shadow-lg">
                        <span class="font-bold tracking-widest uppercase text-[10px] text-white drop-shadow-md">Sancaka e-Pesantren</span>
                    </div>

                    <h1 class="text-6xl font-black leading-tight text-white mb-6" 
                        style="text-shadow: 0 4px 15px rgba(0,0,0,0.5), 0 0 30px rgba(255,255,255,0.2);">
                        Manajemen <br> Jadi Lebih <span class="text-indigo-300">Mudah.</span>
                    </h1>

                    <p class="text-xl text-indigo-50 font-medium leading-relaxed drop-shadow-lg"
            ...
            <div class="flex items-center justify-center p-8 sm:p-12 lg:p-20">
                <div class="w-full max-w-md mx-auto bg-white/90 backdrop-blur-xl p-10 rounded-[2.5rem] shadow-2xl border border-white/20">
                    ...
                    <form method="POST" action="{{ route('login') }}" class="space-y-6">
                        ...
                        <div class="flex items-center justify-between px-1">
                            <label class="flex items-center cursor-pointer group">
                                ...
                                <span class="ml-3 text-sm text-gray-600 group-hover:text-indigo-600 transition-colors font-medium">Ingat saya</span>
                            </label>
                        ...
                        <div class="pt-4">
                            <button type="submit" class="w-full py-4 px-4 border border-transparent text-lg font-bold rounded-2xl text-white bg-indigo-600 hover:bg-indigo-700 shadow-xl shadow-indigo-200 transition-all duration-300 transform hover:-translate-y-1">
                                Masuk Sekarang
                            </button>
                        </div>
