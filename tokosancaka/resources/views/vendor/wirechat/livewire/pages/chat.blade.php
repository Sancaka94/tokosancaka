<div class="w-full flex min-h-full h-full rounded-lg" >
    <div class=" hidden md:grid bg-inherit border-r border-[var(--wc-light-border)]    relative w-full h-full md:w-[360px] lg:w-[400px] xl:w-[500px]  shrink-0 overflow-y-auto  ">
