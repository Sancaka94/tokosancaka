...
<div x-ref="members"
    class="h-[calc(100vh_-_6rem)]  sm:h-[450px] bg-[var(--wc-light-primary)] border border-[var(--wc-light-secondary)]  overflow-y-auto overflow-x-hidden  ">
    ...
    <header class=" sticky top-0 bg-[var(--wc-light-primary)] z-10 p-2">
        ...
        <section class="flex flex-wrap items-center px-0 border-b">
            <input type="search" id="users-search-field" wire:model.live.debounce='search' autocomplete="off"
                ...
                class=" w-full border-0 w-auto outline-hidden focus:outline-hidden bg-[var(--wc-dark-parimary)] rounded-lg focus:ring-0 hover:ring-0">
        </section>
                ...
                <ul class="overflow-auto flex flex-col">
                    ...
                    @foreach ($participants as $key => $participant)
                        ...
                        <li x-data="{ open: false }" x-ref="button" @click="open = ! open" x-init="$watch('open', value => {
                            ...
                            :class="!open || 'bg-[var(--wc-light-secondary)]'"
                            ...
                            <label class="flex cursor-pointer gap-2 items-center w-full">
                                ...
                                <div x-show="open" x-anchor.bottom-end="$refs.button"
                                    class="ml-auto bg-[var(--wc-light-secondary)] border-[var(--wc-light-primary) py-4 shadow-sm border rounded-md grid space-y-2 w-52">
                                    {{-- <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 text-gray-600  w-6 h-6">
