<div class="bg-[var(--wc-light-primary)]  overfo opaticy-100   min-h-screen w-full">
    <section class="flex gap-4 z-10  items-center p-5 sticky top-0 bg-[var(--wc-light-primary)]   ">
    ...
    <div class="">
        <section >
            ...
            <h5 class="w-full text-start py-4 bg-[var(--wc-light-secondary)] px-4">
                ...
                <li class="w-full flex  p-5">
                    ...
                    <span class="w-12">
                        ...
                        <label class="inline-flex items-center cursor-pointer">
                            ...
                            after:start-[2px]  after:bg-white after:shadow 
                            ...
                            after:border-[var(--wc-light-primary)] after:border 
                ...
                <li class="w-full flex items-center p-5">
                  ...
                  <li class="w-full flex items-center p-5">
                    <span class="w-12">
                           ...
                           <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6 w-6 h-6 text-gray-500">
