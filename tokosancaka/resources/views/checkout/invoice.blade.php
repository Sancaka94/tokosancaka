        ...
        <div class="bg-white rounded-xl shadow-2xl w-full max-w-4xl overflow-hidden">
            ...
            <div class="flex flex-col md:flex-row">
                ...
                <div class="w-full md:w-1/2 p-8">
                    ...
                    {{-- ====================================================== --}}
                    {{-- ==== PERBAIKAN: BAGIAN RINCIAN BIAYA LENGKAP ==== --}}
                    {{-- ====================================================== --}}
                    <div class="mt-6 space-y-4">
                        ...
                        {{-- TAMBAHAN: Tampilkan Biaya COD jika ada --}}
                        @if($order->cod_fee > 0)
                        <div class="flex justify-between text-sm text-gray-600">
                        ...
                        {{-- TAMBAHAN: Tampilkan Asuransi jika ada --}}
                    ...
                    <div class="mt-8 text-center">
                        @php
                            ...
                            $badgeClass = match($status) {
                                ...
                                'paid'       => 'bg-green-100 text-green-800 border border-green-300', // Tambahan status 'paid'
                                'failed'     => 'bg-red-100 text-red-800 border border-red-300', // Tambahan status 'failed'
                                'expired'    => 'bg-gray-100 text-gray-800 border border-gray-300', // Tambahan status 'expired'
                     ...
                     @if($status === 'pending')
                         <div class="h-full flex flex-col justify-center">
                             ...
                             <div class="text-center">
                                 ...
                                 @else
                                     {{-- Default tombol bayar (termasuk DOKU_JOKUL) --}}
                             ...
                             <div class="mt-6 text-center">
                                 <a href="{{ route('checkout.index') }}" class="text-sm text-gray-600 hover:text-gray-800 hover:underline">
                                     &larr; Kembali ke Halaman Checkout
                                 </a>
                             </div>
                             {{-- =================================== --}}

                         </div>
                     @elseif(in_array($status, ['processing', 'paid', 'shipment', 'completed']))
                         <div class="h-full flex flex-col justify-center items-center text-center">
                            <svg class="w-16 h-16 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                             <h2 class="text-lg font-semibold text-gray-800 mt-4">Pembayaran Berhasil</h2>
                             <p class="text-gray-600 mt-2">Terima kasih telah berbelanja. Pesanan Anda sedang diproses.</p>
                             
                            {{-- ========================================== --}}
                            {{-- ==== PERBAIKAN: TOMBOL LANJUT BELANJA ==== --}}
                            {{-- ========================================== --}}
                            <a href="https://tokosancaka.com/etalase" class="inline-block mt-6 px-6 py-2 bg-red-600 text-white font-semibold rounded-lg shadow-md hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-opacity-75 transition-transform transform hover:scale-105">
                                Lanjut Belanja
                            </a>
                            {{-- ========================================== --}}
                     ...
                     @else
                         <div class="h-full flex flex-col justify-center items-center text-center">
                            <svg class="w-16 h-16 text-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                             <h2 class="text-lg font-semibold text-gray-800 mt-4">Pesanan Dibatalkan</h2>
                             <p class="text-gray-600 mt-2">Status pesanan ini adalah {{ $status }}.</p>
                         </div>
                     @endif
