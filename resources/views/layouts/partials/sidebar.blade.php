...
<div x-data="{ sidebarOpen: false, isExpanded: false, isHovered: false }" class="h-full flex flex-col">
    ...
    <aside id="main-sidebar" 
        ...
        class="bg-blue-900 text-gray-300 flex-shrink-0 flex flex-col h-[133.33vh] relative fixed inset-y-0 left-0 z-50 transform transition-all duration-300 lg:static lg:inset-auto shadow-xl overflow-hidden">
