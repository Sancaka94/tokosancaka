{{-- ========================================================= --}}
            ...
            <div x-data="{ activityOpen: false }" 
                ...
                <div @mouseenter="activityOpen = true"
                     class="absolute right-0 top-[35%] transform -translate-y-1/2 pointer-events-auto bg-blue-600 text-white py-4 px-1 rounded-l-xl shadow-lg cursor-pointer transition-all duration-300 hover:bg-blue-700 hover:pr-3 z-[81]"
