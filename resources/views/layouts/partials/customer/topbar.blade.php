    ...
    <div class="container flex items-center justify-between h-16 px-6 mx-auto text-indigo-600 dark:text-indigo-300">
        ...
        <div class="flex items-center">
            ...
            <nav class="hidden md:flex items-center ml-6 space-x-1">
                ...
                <a class="px-3 py-2 text-sm font-medium text-gray-700 transition-colors duration-150 rounded-lg hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700 {{ request()->routeIs('customer.laporan-keuangan') ? 'bg-gray-100 dark:bg-gray-700' : '' }}" href="{{ route('customer.laporan-keuangan') }}">
                    Keuangan
                </a>
            </nav>
        </div>
    ...
    <div x-show="isMobileMenuOpen" @click.away="isMobileMenuOpen = false" class="md:hidden">
        <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <a class="block px-3 py-2 text-base font-medium text-gray-700 transition-colors duration-150 rounded-md hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700" href="#">
             ...
             <a class="block px-3 py-2 text-base font-medium text-gray-700 transition-colors duration-150 rounded-md hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700 {{ request()->routeIs('customer.laporan-keuangan') ? 'bg-gray-100 dark:bg-gray-700' : '' }}" href="{{ route('customer.laporan-keuangan') }}">
                Laporan Keuangan
            </a>
        </div>
    </div>
