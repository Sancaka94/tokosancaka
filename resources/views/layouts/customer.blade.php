...
<body class="bg-gray-100 text-gray-800 flex flex-col min-h-screen">
    ...
    <div x-data="{ sidebarOpen: false, isNotificationsMenuOpen: false, isProfileMenuOpen: false }" class="flex flex-1 overflow-hidden">
        <!-- Sidebar -->
    ...
    {{-- ✅ DITAMBAHKAN: Footer Profesional --}}
    <footer class="bg-white text-gray-600 body-font">
        <div class="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
            <a class="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
                 <img src="https://tokosancaka.biz.id/storage/uploads/sancaka.png" alt="Logo Sancaka Express" class="w-10 h-10">
                <span class="ml-3 text-xl">Sancaka Express</span>
            </a>
