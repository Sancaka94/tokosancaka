        ...
        <div class="col-lg-8 col-md-10">
            ...
            <div class="card tracking-card">
                <div class="card-body p-4 p-md-5">
                    ...
                    <p class="text-center text-muted mb-4">Masukkan nomor resi Sancaka Express atau SPX Express untuk melihat status pengiriman paket Anda.</p>
            ...
            <div class="card tracking-card mt-5">
                ...
                <div class="card-body p-4 p-md-5">
                    ...
                    @if ($result['is_pesanan'])
                        @if($result['status'] == 'Sedang Dikirim' || $result['status'] == 'shipment')
                            <div class="alert alert-danger shadow-sm border-0 fw-semibold my-4" role="alert">
                                <h5 class="alert-heading fw-bold">📦 Paket Telah Diserahkan</h5>
                                <p>Berikut adalah Nomor Resi {{$result['resi']}} Anda dan Status Paket Anda Sekarang {{$result['status']}} Semoga Paket Kakak Aman dan Selamat Sampai Tujuan</p>
                                <hr>
