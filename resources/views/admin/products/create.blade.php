             ...
             <div class="space-y-4">
               ...
               <div>
                 ...
                 <div class="relative mt-1">
                   ...
                   <input type="tel" name="seller_wa" id="seller_wa" inputmode="numeric" placeholder="81234567890" value="{{ old('seller_wa') }}" pattern="^(\+?62|0)?8[1-9][0-9]{6,11}$"
                 ...
                 <p id="seller_wa_help" class="mt-1 text-xs text-gray-500">Format: mulai dari 8xxxxxxxxxx. Contoh: 81234567890</p>
               </div>
               <div>
                 ...
                 <label for="seller_logo" id="seller_logo_dropzone"
                   ...
                   <div class="text-sm text-gray-700">
                     <span class="font-medium">Tarik & lepas</span> logo atau <span class="font-medium text-indigo-600 underline">klik untuk pilih</span>
                   </div>
...
@push('scripts')
{{-- Kode JavaScript untuk preview gambar dan submit button tetap sama --}}
<script>
