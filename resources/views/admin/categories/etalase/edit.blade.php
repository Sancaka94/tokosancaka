    ...
    <form action="{{ route('admin.categories.update', $category) }}" method="POST">
        ...
        <div class="space-y-4">
            ...
            <div>
                ...
                <p class="mt-1 text-xs text-gray-500">Gunakan class dari <a href="[https://fontawesome.com/v5/search](https://fontawesome.com/v5/search)" target="_blank" class="text-indigo-600 hover:underline">Font Awesome 5</a>.</p>
            </div>
        </div>
