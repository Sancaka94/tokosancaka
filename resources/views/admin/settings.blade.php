                                ...
                                <template x-for="user in filteredUsers" :key="user.id_pengguna">
                                    <tr class="bg-white border-b hover:bg-gray-50">
                                        ...
                                        <td class="px-6 py-4">
                                            ...
                                            <img :src="user.store_logo_path ? '{{ asset('public/storage/store-logos/' . '/') }}' + user.store_logo_path : 'https://ui-avatars.com/api/?name=' + encodeURIComponent(user.nama_lengkap || 'User') + '&color=7F9CF5&background=EBF4FF'"
