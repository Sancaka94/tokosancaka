...
<div class="space-y-6">
    ...
    <div class="bg-white dark:bg-gray-800 shadow-md rounded-lg p-6">
        ...
        <!-- PERBAIKAN 2: Menampilkan Error Validasi Server -->
        @if ($errors->any())
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div>
                        ...
                        <div class="flex items-center space-x-2 mt-1">
                            <input type="text" name="title" id="title" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white sm:text-sm" placeholder="Ketik judul di sini..." value="{{ old('title') }}" required>
                        ...
                        <!-- PERBAIKAN 1: Notifikasi untuk Judul Pendek (menggantikan alert) -->
                        <div id="title-error" class="hidden mt-2 text-sm text-red-600">Judul harus memiliki minimal 10 karakter untuk generate konten AI.</div>
                    </div>
                    ...
                    <div>
                        ...
                        <div id="loading-indicator" class="hidden my-2 text-sm text-gray-500"><i class="fas fa-spinner fa-spin mr-2"></i>Menghasilkan artikel, mohon tunggu...</div>
