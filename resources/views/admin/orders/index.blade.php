...
@section('content')
{{-- 1. Tambahkan container wrapper untuk membatasi lebar halaman --}}
<div class="container mx-auto max-w-7xl">
    {{-- 
      Wrapper 'w-full min-w-0' ini PENTING.
      Ini mencegah area konten (flex item) agar tidak melebar 
      melebihi layout utama saat tabel di dalamnya overflow.
    --}}
    <div class="w-full min-w-0 px-4 sm:px-6 lg:px-8 py-6">
        
        {{-- 
          Kartu putih utama. 
          'overflow-hidden' "memaksa" tabel di dalamnya untuk 
        ...
        <div class="bg-white shadow border border-gray-200 rounded-lg overflow-hidden">
            ...
            {{-- TABEL --}}
            {{-- 2. Tambahkan 'max-w-full' ke wrapper tabel --}}
            <div class="max-w-full overflow-x-auto">
                {{-- 3. Hapus 'w-full' dari tabel --}}
