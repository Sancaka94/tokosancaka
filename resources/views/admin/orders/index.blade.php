...
<div class="bg-white shadow border border-gray-200 rounded-lg overflow-hidden">
    ...
    {{-- TABEL --}}
    {{-- Hapus div wrapper overflow-x-auto dari sini --}}
    {{-- Hapus 'w-full' dari tabel --}}
    <table class="min-w-full text-sm text-gray-700 divide-y divide-gray-200"> {{-- Tambahkan min-w-full agar tabel mengisi horizontal --}}
