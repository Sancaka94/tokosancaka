            ...
            <div class="lg:col-span-2 space-y-8">
                ...
                <div class="bg-white p-6 rounded-lg shadow-md">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <select id="customer_id" name="id_pengguna_pembeli" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5">
                                ...
                                @foreach($customers as $customer)
                                    {{-- ✅ DIPERBAIKI: Menggunakan $customer->id sesuai validasi controller --}}
                        ...
                        <div>
                            ...
                            <input type="text" id="sender_name" name="sender_name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5" required>
                        </div>
                        <div>
                            <label for="sender_phone" class="block mb-2 text-sm font-medium text-gray-700">Nomor HP</label>
                            <input type="tel" id="sender_phone" name="sender_phone" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5" required>
                        </div>
                        <div class="md:col-span-2 relative">
                            <label for="sender_address_search" class="block mb-2 text-sm font-medium text-gray-700">Cari Alamat (Kec/Kel/Kodepos)</label>
                        ...
                        <div class="md:col-span-2">
                            <label for="sender_address" class="block mb-2 text-sm font-medium text-gray-700">Detail Alamat Pengirim</label>
                            <textarea id="sender_address" name="sender_address" rows="3" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5" required></textarea>
                        </div>
                         <div class="md:col-span-2">
                ...
                <div class="bg-white p-6 rounded-lg shadow-md">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2 relative">
                            <label for="receiver_address_search" class="block mb-2 text-sm font-medium text-gray-700">Cari Alamat (Kec/Kel/Kodepos)</label>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    async function runCekOngkir() {
        ...
        try {
            ...
            // Pastikan route 'kirimaja.cekongkir' sudah ada di web.php/api.php
            ...
            // Menggabungkan hasil dari instant/sameday (res.result) dan reguler (res.results)
                ...
                card.innerHTML = `
                    <div class="p-4 flex justify-between items-center">
                        ...
                        <div class="text-right">
                            ...
                            <button type="button" class="btn-sm mt-1 select-ongkir-btn bg-indigo-600 text-white px-3 py-1 rounded-md hover:bg-indigo-700" data-value="${value}" data-display="${item.service_name}" data-cod-supported="${isCod}">Pilih</button>
                        </div>
                    </div>
                `;
    ...
    // Reset pilihan ongkir jika ada data yang berubah
    ...
    document.getElementById('confirmBtn').addEventListener('click', (e) => {
        ...
        // Pengecekan manual untuk field yang diisi oleh JS
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                // Menambahkan loading state pada tombol
