...
<div class="container mx-auto px-4 py-6">
    ...
    {{-- =========================================================== --}}
    {{-- 2. GRID LABA RUGI (TAMPILAN UTAMA) --}}
    {{-- =========================================================== --}}
    <div class="grid grid-cols-1 md:grid-cols-2 gap-0 border border-gray-300 bg-white shadow-lg rounded-t-xl overflow-hidden">
            ...
            <div class="p-6 flex-1">
                <table class="w-full text-sm">
                    <tbody class="divide-y divide-gray-100">
                        {{-- LOOPING PENDAPATAN --}}
                        @forelse($pendapatan as $nama => $nilai)
                        ...
                        @empty
                        <tr>
                            <td colspan="2" class="py-4 text-center text-gray-400 italic">Belum ada data pendapatan.</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
        ...
        <div class="flex flex-col">
            ...
            <div class="p-6 flex-1">
                <table class="w-full text-sm">
                    <tbody class="divide-y divide-gray-100">
                        ...
                        {{-- 2. LOOPING BEBAN OPERASIONAL --}}
                        @forelse($beban as $nama => $nilai)
                        <tr class="hover:bg-gray-50 transition group">
                        ...
                        @empty
                        <tr>
                            <td colspan="2" class="py-4 text-center text-gray-400 italic">Belum ada data pengeluaran.</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
            ...
            <div class="bg-red-100 p-4 border-t border-red-200 flex justify-between items-center mt-auto">
                ...
                <span class="font-bold text-xl text-red-700">Rp{{ number_format($totalBeban + ($hpp ?? 0), 0, ',', '.') }}</span>
            </div>
        </div>
    </div>
