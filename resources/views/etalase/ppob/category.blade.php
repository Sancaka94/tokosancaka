...
<script>
    ...
    // ⭐ BARU: AKTIF SKU DARI PHP
    const inquirySkuElement = document.getElementById('inquiry_sku_code');
    const ACTIVE_SLUG = "{{ $currentSlug }}"; 
    const ACTIVE_SKU_GLOBAL = inquirySkuElement ? inquirySkuElement.value : 'pulsa'; // Diubah namanya untuk menghindari konflik
    ...
    @if(!$isPostpaid)
        ...
        // Logic Autodeteksi Operator (disederhanakan untuk brevity)
    ...
    function cekTagihan() {
        ...
        // Dapatkan SKU yang akan digunakan
        const inquirySkuElement = document.getElementById('inquiry_sku_code');
        ...
        // Bersihkan Nomor Pelanggan berdasarkan SLUG
        let cleanNo = ACTIVE_SLUG.includes('samsat') ? no : no.replace(/[^0-9]/g, ''); 
