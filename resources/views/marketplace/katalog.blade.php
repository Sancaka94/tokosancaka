...
<style>
    ...
    .flash-sale-nav, .category-nav { top: 50%; transform: translateY(-50%); } /* Terapkan pada kategori juga */
...
<div class="container mx-auto py-6 px-4">
    ...
    <section class="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-8">
        <div class="lg:col-span-2 rounded-lg overflow-hidden shadow-sm h-[200px] md:h-[270px]">
            {{-- PERBAIKAN: Mengisi bagian banner carousel --}}
            <div class="swiper heroSwiper w-full h-full">
                <div class="swiper-wrapper">
                    @forelse($banners as $banner)
                        <div class="swiper-slide">
                            {{-- Asumsi model Banner memiliki properti 'image' dan 'title' --}}
        ...
        <div class="grid grid-rows-2 gap-4 h-[200px] md:h-[270px]">
             {{-- PERBAIKAN: Mengisi bagian banner samping (statis) --}}
    ...
    <section class="mb-8">
        {{-- PERBAIKAN: Mengisi bagian Flash Sale --}}
                            ...
                            <div class="border rounded-lg overflow-hidden h-full flex flex-col bg-white text-left transition-shadow duration-300 hover:shadow-md">
                                ...
                                <div class="p-3 flex flex-col flex-grow">
                                    ...
                                    <div class="mt-auto pt-3">
                                        @if($product->stock > 0)
                                        {{-- Sesuaikan route ini dengan route 'add to cart' Anda --}}
    ...
    <section>
        {{-- PERBAIKAN: Mengisi bagian Rekomendasi Produk --}}
...
document.addEventListener('DOMContentLoaded', function () {
    // PERBAIKAN: Mengisi dan melengkapi inisialisasi Swiper
