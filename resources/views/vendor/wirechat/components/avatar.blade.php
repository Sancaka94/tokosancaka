...
<div
    {{ $attributes->merge([
            'class' => "shrink-0 inline-flex items-center justify-center   relative transition
                          overflow-visible rounded-full border border-[var(--wc-light-secondary)] text-gray-300  bg-[var(--wc-light-secondary)]
                           text-base ",
        ])->class(
    ...
    @if (!$src && $group==true)
        {{-- <svg class="shrink-0 scale-90 w-full h-full rounded-full text-gray-300 bg-gray-100" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16">
            <path d="M7 14s-1 0-1-1 1-4 5-4 5 3 5 4-1 1-1 1zm4-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6m-5.784 6A2.24 2.24 0 0 1 5 13c0-1.355.68-2.75 1.936-3.72A6.3 6.3 0 0 0 5 9c-4 0-5 3-5 4s1 1 1 1zM4.5 8a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5" />
        </svg> --}}

        {{-- <svg class="shrink-0 scale-95 w-full h-full rounded-full text-gray-300 bg-gray-100" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" aria-hidden="true" data-slot="icon">
        ...
        <svg class="shrink-0 p-px w-full h-full rounded-full text-gray-400 bg-gray-100 bg-[var(--wc-light-secondary)]"
    ...
    @if ($disappearing)
        <span dusk="disappearing_messages_icon"
            class="absolute z-50 -bottom-1 bg-white -right-2 rounded-full p-px">
