...
<div class="flex items-center group overflow-hidden border border-[var(--wc-light-secondary)] rounded-xl">
    <span class=" p-2">
    ...
    <button class="px-3 bg-gray-50 bg-[var(--wc-light-secondary)] transition-colors ease-in-out  hover:text-blue-500   p-1 mt-auto   h-full">
