...
<header class="px-3 z-10 sticky top-0 w-full py-2 " dusk="header">
        ...
        <div class="flex gap-x-3 items-center  ">
            ...
            <x-wirechat::actions.new-chat widget="{{$this->isWidget()}}">
                <button id="open-new-chat-modal-button" class=" flex items-center focus:outline-hidden">
                    <svg class="w-8 h-8 -mb-1 text-gray-500 cursor-pointer hover:text-gray-900"
            ...
            <a id="redirect-button" href="{{ config('wirechat.home_route', '/') }}" class="flex items-center">
                {{-- <svg xmlns="http://www.w3.org/2000/svg"  fill="currentColor" class="bi bi-x-octagon-fill w-6 h-6 text-gray-500 transition-colors duration-300 hover:text-gray-900" viewBox="0 0 16 16">
    ...
    @if ($allowChatsSearch)
        <section class="mt-4">
            <div class="px-2 rounded-lg  bg-[var(--wc-light-secondary)]  grid grid-cols-12 items-center">
