...
<div class="bg-slate-50 min-h-screen">
    <div class="container mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div class="mb-8 rounded-xl bg-white p-6 shadow-lg">
            <form method="GET" action="{{ route('customer.laporan-keuangan') }}" class="grid grid-cols-1 gap-6 sm:grid-cols-3 lg:grid-cols-4 items-end">
                <div>
                ...
                <div class="sm:col-span-1 lg:col-span-2 flex space-x-3">
                    ...
                    <a href="{{ route('customer.laporan-keuangan') }}" class="inline-flex w-full justify-center rounded-md border border-slate-300 bg-white py-2 px-4 text-sm font-medium text-slate-700 shadow-sm hover:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
                        Reset
                    </a>
                </div>
            </form>
