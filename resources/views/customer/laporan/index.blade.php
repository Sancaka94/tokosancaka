...
<div class="bg-slate-50 min-h-screen">
    <div class="container mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div class="mb-8 rounded-xl bg-white p-6 shadow-lg">
            <form action="{{ route('customer.laporan.index') }}" method="GET" class="grid grid-cols-1 gap-4 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 items-end">
                <div>
                ...
                <div class="flex space-x-2">
                    ...
                    <a href="{{ route('customer.laporan.index') }}" class="inline-flex w-full justify-center items-center rounded-md border border-slate-300 bg-white px-4 py-2 text-sm font-medium text-slate-700 shadow-sm hover:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
                        Reset
                    </a>
                </div>
            </form>
