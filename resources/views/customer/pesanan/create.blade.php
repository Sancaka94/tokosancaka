...
<div class="max-w-7xl mx-auto">
    ...
    {{-- SELESAI KODE DINAMIS --}}
                ...
                <div class="bg-white p-6 rounded-lg shadow-md border border-red-700 transition-all duration-200 hover:ring-4 hover:ring-red-400 hover:shadow-lg">
                    ...
                    <div class="bg-red-600 backdrop-blur border-b border-red-700 px-4 py-3 rounded-lg shadow flex items-center justify-between mb-6">
                        ...
                        <div class="relative w-1/2">
                            ...
                            class="w-full pl-10 pr-4 py-2 bg-white border border-gray-300 rounded-lg text-sm text-gray-900 focus:outline-none focus:border-red-500 focus:ring-4 focus:ring-white focus:shadow-md" placeholder="Cari dari kontak pengirim..." autocomplete="off">
                ...
                <div class="bg-white p-6 rounded-lg shadow-md border border-blue-700 transition-all duration-200 hover:ring-4 hover:ring-blue-400 hover:shadow-lg">
                    <div class="flex justify-between items-center bg-blue-600 text-white px-4 py-3 mb-6 rounded-lg shadow">
