    ...
    <div class="container mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div class="mb-8 text-center md:text-left">
            ...
            <p class="mt-2 text-lg text-slate-600">
                Berikut adalah riwayat semua pesanan yang telah Anda buat, lengkap dengan detailnya.
            </p>
        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-12 gap-4 items-start">
                        ...
                        <div class="md:col-span-3 p-4 border-t md:border-t-0 md:border-l border-slate-200 space-y-3">
                            ...
                            <div class="flex items-start">
                                ...
                                <div>
                                    ...
                                    <div class="text-xs text-slate-600">{{ $order->receiver_address }}</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="md:col-span-2 p-4 border-t md:border-t-0 md:border-l border-slate-200">
                            ...
                            <div class="text-sm text-slate-600 mt-2">
                                Ongkir: <span class="font-bold text-red-600">Rp {{ number_format($order->price ?? 0, 0, ',', '.') }}</span>
                            </div>
                            <div class="text-xs text-slate-500 break-all">
                                Resi: {{ $order->resi ?? 'Menunggu' }}
                            </div>
                        </div>
                        ...
                        <div class="md:col-span-2 p-4 flex flex-col items-center justify-center border-t md:border-t-0 md:border-l border-slate-200">
                            ...
                            @php
                                ...
                                switch ($status) {
                                    ...
                                    case 'Sedang Dikirim': $statusClass = 'bg-blue-100 text-blue-800'; break;
                                    case 'Dalam Proses Retur': $statusClass = 'bg-orange-100 text-orange-800'; break;
                                    case 'Selesai': 
                                    case 'Retur Selesai': $statusClass = 'bg-green-100 text-green-800'; break;
                            ...
                            @if ($order->status_pesanan === 'Menunggu Pembayaran' && $order->payment_url)
                                <a href="{{ $order->payment_url }}" target="_blank" class="mt-2 text-indigo-600 hover:text-indigo-900 font-semibold text-sm">
                                    Bayar Sekarang
                                </a>
                            @elseif ($order->resi)
                ...
                <div class="text-center py-16 bg-white rounded-xl shadow-md border border-slate-200">
                    <div class="mx-auto max-w-md">
                        ...
                        <p class="mt-1 text-sm text-slate-500">
                            Anda belum pernah membuat pesanan. Mulai kirim paket sekarang!
                        </p>
                        <div class="mt-6">
