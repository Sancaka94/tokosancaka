            ...
            <div class="lg:col-span-7">
                <div class="bg-white p-6 shadow-md rounded-xl h-full">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" id="customer-info-input" class="mt-1 block w-full bg-gray-100 border-gray-300 rounded-md shadow-sm" value="{{ $customer->nama_lengkap }} ({{ $customer->no_wa }})" readonly>
                    </div>
