            ...
            <div class="p-6 md:p-8">
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div class="lg:col-span-1">
                        <div class="flex flex-col items-center text-center">
                            <img src="{{ $user->store_logo_path ? asset('storage/' . $user->store_logo_path) : 'https://placehold.co/128x128/e2e8f0/64748b?text=Logo' }}" 
                                 alt="Logo Toko" 
                ...
                <div class="mt-8 pt-6 border-t border-slate-200 text-right">
                    <a href="{{ route('customer.profile.edit') }}" 
                       class="inline-flex items-center px-5 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white font-semibold text-sm rounded-lg shadow-md transition duration-150 ease-in-out">
