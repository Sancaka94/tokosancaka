                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center space-x-3">
                                <div class="flex-shrink-0 h-8 w-8 relative">
                                    @php
                                        // Logika untuk menentukan nama file gambar
                                    ...
                                    <img class="h-8 w-8 rounded-full object-contain bg-gray-50 p-1 border border-gray-200" 
                                         ...
                                         onerror="this.onerror=null; this.src='https://ui-avatars.com/api/?name={{ urlencode($order->expedition) }}&background=random&color=fff&size=32';">
                                </div>
