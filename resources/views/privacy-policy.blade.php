        ...
        <div class="col-lg-10">
            ...
            <div class="card shadow-lg border-0 rounded-4">
                <div class="card-body p-5">
                    ...
                    <h2 class="fw-bold mb-4 text-center">Kebijakan Privasi</h2>
                    ...
                    <h5 class="fw-bold mt-4">2. Cara Pengumpulan Data</h5>
                    <p>Data diperoleh melalui:</p>
                    <ul>
                    ...
                    <h5 class="fw-bold mt-4">3. Tujuan Penggunaan Informasi</h5>
                    ...
                    <h5 class="fw-bold mt-4">6. Pembagian Informasi</h5>
                    <p>Kami tidak menjual atau menyewakan data pribadi Anda. Informasi dapat dibagikan hanya kepada:</p>
                    <ul>
                    ...
                    <h5 class="fw-bold mt-4">7. Hak Pengguna</h5>
                    ...
                    <p class="mt-4 text-center text-muted">
                        Terima kasih telah mempercayakan belanja dan layanan Anda kepada kami.
                    </p>
