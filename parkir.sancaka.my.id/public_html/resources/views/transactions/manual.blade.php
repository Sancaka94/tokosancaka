        ...
        <div class="mx-auto max-w-3xl sm:px-6 lg:px-8">
            <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="mb-6">
                        <h3 class="text-lg font-medium leading-6 text-gray-900">Form Transaksi Darurat / Manual</h3>
                        <p class="mt-1 text-sm text-gray-500">Gunakan form ini untuk mencatat kendaraan yang masuk tanpa tiket atau saat sistem sedang down.</p>
                    </div>
                    ...
                    <form action="{{ route('transactions.storeManual') }}" method="POST">
                        @csrf

                        <div class="mb-4">
                            <label for="plate_number" class="block text-sm font-medium text-gray-700">Plat Nomor</label>
                            <input type="text" name="plate_number" id="plate_number" value="{{ old('plate_number') }}" required placeholder="Contoh: AE 1234 XX" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                            @error('plate_number')
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="fee" id="fee" value="{{ old('fee') }}" required min="0" placeholder="Contoh: 10000" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                            @error('fee')
                                <p class="mt-1 text-xs text-red-500">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <input type="number" name="toilet_fee" id="toilet_fee" value="{{ old('toilet_fee', 2000) }}" min="0" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
