...
<div class="bg-white rounded-xl mb-6 border-t-4 border-blue-600 shadow-sm no-print p-4 md:p-5">
    <form action="{{ route('laporan.bulanan') }}" method="GET" class="flex flex-col sm:flex-row gap-4 items-end">
        <div class="w-full sm:w-auto flex-1 md:flex-none">
            ...
            <select name="bulan" class="w-full border border-gray-300 rounded-md py-2 px-3 focus:ring-blue-500 focus:border-blue-500">
                @for($m=1; $m<=12; $m++)
...
<div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden mb-8">
    <div class="bg-white border-b-2 border-gray-100 text-center py-5">
        <h2 class="text-xl font-bold text-gray-800 uppercase tracking-wider">Rekap Pendapatan Parkir Bulanan</h2>
        <p class="text-gray-500 font-medium mt-1">Periode: {{ date('F', mktime(0, 0, 0, $bulan, 1)) }} {{ $tahun }}</p>
    </div>
    ...
    <div class="overflow-x-auto p-0">
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-100">
                ...
                @empty
                <tr>
                    <td colspan="6" class="px-4 py-8 text-center text-gray-500 italic">Tidak ada transaksi keluar pada bulan ini.</td>
                </tr>
                @endforelse
            </tbody>
    ...
    <div class="overflow-x-auto p-0">
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-100">
                ...
                @empty
                <tr>
                    <td colspan="4" class="px-4 py-8 text-center text-gray-500 italic">Tidak ada catatan kas manual pada bulan ini.</td>
                </tr>
                @endforelse
            </tbody>
