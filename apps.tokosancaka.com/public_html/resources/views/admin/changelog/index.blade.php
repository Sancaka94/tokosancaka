...
<div class="py-12 bg-gray-50 min-h-screen">
    <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-xl p-6 md:p-8 relative">
            ...
            @if(empty($commits))
                {{-- TAMPILAN JIKA FILE version.json TIDAK DITEMUKAN --}}
                <div class="text-center py-12">
                    ...
                    <h3 class="text-lg font-bold text-slate-700">Tidak ada riwayat pembaruan</h3>
                    <p class="text-slate-500 max-w-sm mx-auto mt-2 text-sm">
                        File <code class="bg-yellow-100 text-yellow-700 px-1 py-0.5 rounded font-bold">version.json</code> belum di-upload ke server.
                    </p>
                    <p class="text-xs text-slate-400 mt-4">
                        Silakan generate di local (<code>php artisan app:generate-version</code>) lalu upload hasilnya.
                    </p>
                </div>
            @else

                {{-- GARIS TENGAH (Hanya di layar besar) --}}
                        ...
                        <div class="relative flex flex-col md:flex-row gap-4 md:gap-0 group">
                            ...
                            <div class="md:w-1/2 md:pr-12 md:text-right flex flex-col justify-center order-2 md:order-1 pl-12 md:pl-0">
                                ...
                                <div class="flex items-center md:justify-end gap-2">
                                    ...
                                    <span class="text-[10px] font-mono text-slate-400 bg-slate-100 px-1.5 py-0.5 rounded border border-slate-200">
                                        {{ $log['hash'] }}
                                    </span>
                                </div>
                            </div>
                            ...
                            <div class="md:w-1/2 md:pl-12 order-1 md:order-2 pl-12">
                                <div class="bg-slate-50 p-4 rounded-xl border border-slate-100 group-hover:bg-white group-hover:shadow-md group-hover:border-blue-200 transition-all duration-300">
                                    ...
                                    <div class="mt-2 flex items-center gap-2">
                                        <div class="w-5 h-5 rounded-full bg-indigo-100 flex items-center justify-center text-[10px] font-bold text-indigo-600 uppercase">
