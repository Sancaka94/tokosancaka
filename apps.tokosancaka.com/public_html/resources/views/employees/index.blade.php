                ...
                <table class="w-full text-left text-sm text-slate-600">
                    <thead class="bg-slate-50 text-slate-800 font-bold uppercase text-xs border-b border-slate-200">
                        <tr>
                            ...
                            @endif
                            <th class="px-6 py-4">Nama User & Penempatan</th>
                    ...
                    <tbody class="divide-y divide-slate-100">
                        ...
                        <tr class="hover:bg-slate-50 transition group">
                            ...
                            <td class="px-6 py-4">
                                ...
                                <div class="text-xs text-slate-500 mb-1">{{ $emp->email }}</div>

                                {{-- LABEL CABANG (OUTLET) --}}
                                @if($emp->outlet)
                                    <div class="mt-1 inline-flex items-center px-2 py-0.5 rounded text-[10px] font-bold bg-emerald-50 border border-emerald-200 text-emerald-700 shadow-sm">
                                        <i class="fas fa-store-alt mr-1"></i> Cabang: {{ $emp->outlet->name }}
                                    </div>
                                @else
                                    <div class="mt-1 inline-flex items-center px-2 py-0.5 rounded text-[10px] font-bold bg-slate-100 border border-slate-200 text-slate-600 shadow-sm">
                                        <i class="fas fa-building mr-1"></i> Pusat Utama
                                    </div>
                                @endif
                            </td>
