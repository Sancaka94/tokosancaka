...
class DanaDashboardController extends Controller
{
    ...
    // --- 2. PENYEMPURNAAN FUNGSI PENARIK DATABASE ---
    private function applyDynamicConfig()
    {
        // Tarik data hanya sekali dari database
        ...
        if ($isProduction) {
            config([
                ...
                'services.dana.base_url'      => 'https://api.dana.id', // URL API Production
                'services.dana.portal_url'    => 'https://m.dana.id/d/portal/oauth', // URL Portal Binding Prod
            ...
            config([
                ...
                'services.dana.base_url'      => 'https://api.sandbox.dana.id', // URL API Sandbox
                'services.dana.portal_url'    => 'https://m.sandbox.dana.id/d/portal/oauth', // URL Portal Binding Sandbox
                'services.dana.redirect_url_oauth' => 'https://apps.tokosancaka.com/dana/callback',
